...
["warhorse",				"WarHorse", 				[("warhorse_chain",0)], itp_merchandise|itp_type_horse, 0, 1224,abundance(50)|hit_points(165)|body_armor(40)|difficulty(4)|horse_speed(40)|horse_maneuver(41)|horse_charge(28)|horse_scale(110),imodbits_horse_basic|imodbit_champion],
...
["splinted_leather_greaves", 	"Splinted Leather Greaves", 	[("splinted_greaves_a",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature,0, 260 , weight(2.3)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(17)|difficulty(0) ,imodbits_armor ],
["splinted_greaves", 			"Splinted Greaves", 			[("leather_greaves_a",0)], itp_merchandise| itp_type_foot_armor | itp_attach_armature,0, 440 , weight(2.8)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(22)|difficulty(0) ,imodbits_armor ],
...
["leather_jacket",			"Leather Jacket",			[("leather_jacket_new",0)],	itp_merchandise|itp_type_body_armor|itp_covers_legs, 0, 500, weight(10)|abundance(100)|head_armor(0)|body_armor(28)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
...
["heavy_lamellar_chainmail",	"Heavy Lamellar Chainmail",	[("tyrk_armor_heavi_c",0)],			itp_merchandise|itp_type_body_armor|itp_covers_legs, 0, 3000, weight(21)|abundance(100)|head_armor(0)|body_armor(55)|leg_armor(13)|difficulty(0), imodbits_armor ],
...
["pointed_helmet",			"Pointed Helmet",			[("tagancha_helm_a",0),		("inv_tagancha_helm_a",ixmesh_inventory)],	itp_merchandise|itp_type_head_armor|itp_attach_armature,	0, 820 , weight(2.7)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate ],
...
##### TIER 6 - 45 ARMOR #####
["heavy_pointed_helmet",	"Heavy Pointed Helmet",		[("tagancha_helm_b",0),	("inv_tagancha_helm_b",ixmesh_inventory)], itp_merchandise|itp_type_head_armor|itp_attach_armature, 0, 950, weight(3.3)|abundance(100)|head_armor(44)|body_armor(0)|leg_armor(0)|difficulty(0), imodbits_plate ],
...
##### Tier 1 #####
["short_sword",	"Short Sword",	[("sword_medieval_c_small",0),("sword_medieval_c_small_scabbard", ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary,itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	450, weight(1.5)|abundance(32)|difficulty(6)|spd_rtng(99)|weapon_length(86)|swing_damage(21, cut)|thrust_damage(15, pierce), imodbits_sword_high ],
["sword",		"Sword",		[("sword_medieval_c",0),("sword_medieval_c_scabbard", ixmesh_carry)],				itp_merchandise|itp_type_one_handed_wpn|itp_primary,itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	400, weight(1.5)|abundance(30)|difficulty(6)|spd_rtng(95)|weapon_length(95)|swing_damage(22, cut)|thrust_damage(12, pierce), imodbits_sword_high ],
["falchion",	"Falchion",		[("falchion_new",0)],																itp_merchandise|itp_type_one_handed_wpn|itp_primary,itc_scimitar|itcf_carry_sword_left_hip,									375, weight(2.5)|abundance(27)|difficulty(8)|spd_rtng(110)|weapon_length(73)|swing_damage(23, cut)|thrust_damage(0, pierce), imodbits_sword ],
...
##### Tier 3 #####
["western_arming_sword",		"Western Arming Sword",		[("crusaders_swords_a",0),("crusader_sword_a_scabbard",ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	750, weight(1.5)|abundance(8)|difficulty(8)|spd_rtng(110)|weapon_length(75)|swing_damage(27, cut)|thrust_damage(17,pierce), imodbits_sword_high ],
["western_infantry_sword_a",	"Western Infantry Sword",	[("crusader_sword_b",0),("crusader_sword_b_scabbard",ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	800, weight(1.5)|abundance(9)|difficulty(8)|spd_rtng(102)|weapon_length(86)|swing_damage(29, cut)|thrust_damage(18,pierce), imodbits_sword_high ],
["western_infantry_sword_b",	"Western Infantry Sword",	[("crusader_sword_c",0),("crusader_sword_c_scabbard",ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	850, weight(1.7)|abundance(12)|difficulty(8)|spd_rtng(100)|weapon_length(86)|swing_damage(30, cut)|thrust_damage(18,pierce), imodbits_sword_high ],

##### Tier 4 #####
["western_long_sword_a", "Western Long Sword", [("k_long_sword_a",0),("k_long_sword_a",ixmesh_carry)], itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	1000, weight(2.0)|abundance(15)|difficulty(12)|spd_rtng(95)|weapon_length(100)|swing_damage(33, cut)|thrust_damage(20, pierce), imodbits_sword_high ],
["western_long_sword_b", "Western Long Sword", [("k_long_sword_b",0),("k_long_sword_b",ixmesh_carry)], itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	1250, weight(2.0)|abundance(13)|difficulty(12)|spd_rtng(93)|weapon_length(100)|swing_damage(34, cut)|thrust_damage(20, pierce), imodbits_sword_high ],
["western_long_sword_c", "Western Long Sword", [("k_long_sword_c",0),("k_long_sword_c",ixmesh_carry)], itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	1500, weight(2.0)|abundance(15)|difficulty(12)|spd_rtng(91)|weapon_length(100)|swing_damage(35, cut)|thrust_damage(21, pierce), imodbits_sword_high ],

##### Tier 5 #####
["western_nobleman_sword_a", "Western Nobleman Sword", [("crusader_long_sword_a",0),("crusader_long_sword_a_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 2000, weight(1.5)|abundance(3)|difficulty(8)|spd_rtng(95)|weapon_length(100)|swing_damage(37, cut)|thrust_damage(22, pierce), imodbits_sword_high ],
["western_nobleman_sword_b", "Western Nobleman Sword", [("crusader_long_sword_b",0),("crusader_long_sword_b_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 3000, weight(1.5)|abundance(4)|difficulty(8)|spd_rtng(92)|weapon_length(100)|swing_damage(37, cut)|thrust_damage(22, pierce), imodbits_sword_high ],
["western_nobleman_sword_c", "Western Nobleman Sword", [("crusader_long_sword_c",0),("crusader_long_sword_c_scabbard",ixmesh_carry)], itp_type_one_handed_wpn|itp_merchandise|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 4000, weight(1.5)|abundance(5)|difficulty(8)|spd_rtng(89)|weapon_length(100)|swing_damage(38, cut)|thrust_damage(23, pierce), imodbits_sword_high ],

########## Northern ###########

##### Tier 3 #####
["nordic_short_sword",	"Nordic Short Sword",	[("sword_viking_b_small",0),("sword_viking_b_small_scabbard", ixmesh_carry)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 1000 , weight(1.25)|abundance(20)|difficulty(2)|spd_rtng(99)|weapon_length(85)|swing_damage(27, cut)|thrust_damage(25, pierce), imodbits_sword_high ],
["nordic_sword",		"Nordic Sword",			[("sword_viking_b",0),("sword_viking_b_scabbard", ixmesh_carry)],					itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 1250 , weight(1.50)|abundance(15)|difficulty(2)|spd_rtng(95)|weapon_length(95)|swing_damage(26, cut)|thrust_damage(24, pierce), imodbits_sword_high ],

##### Tier 4 #####
["nordic_war_sword",		"Nordic War Sword", [("sword_viking_c",0),("sword_viking_c_scabbard ", ixmesh_carry)],					itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 1500, weight(1.50)|abundance(10)|difficulty(2)|spd_rtng(99) |weapon_length(94)|swing_damage(30, cut)|thrust_damage(24, pierce), imodbits_sword_high ] ,
["nordic_short_war_sword",	"Nordic Short War Sword", [("sword_viking_a_small",0),("sword_viking_a_small_scabbard", ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 2000, weight(1.25)|abundance(10)|difficulty(2)|spd_rtng(103)|weapon_length(86)|swing_damage(30, cut)|thrust_damage(26, pierce), imodbits_sword_high ],

##### Tier 5 #####
["nordic_nobleman_sword",	"Nordic Nobleman Sword", [("sword_viking_a",0),("sword_viking_a_scabbard", ixmesh_carry)],				itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 3000 , weight(1.5)|abundance(20)|difficulty(2)|spd_rtng(99)|weapon_length(95)|swing_damage(31 , cut) | thrust_damage(30 ,  pierce),imodbits_sword_high, [], [fac_kingdom_4]],

########## Eastern ###########

##### Tier 1 #####
["scimitar", "Scimitar", [("scimitar_a",0),("scab_scimeter_a", ixmesh_carry)], itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 300, weight(1.5)|abundance(30)|difficulty(2)|spd_rtng(105)|weapon_length(97)|swing_damage(22 , cut)|thrust_damage(0 ,  pierce), imodbits_sword_high ],

##### Tier 2 #####
["scimitar_b", "Elite Scimitar", [("scimitar_b",0),("scab_scimeter_b", ixmesh_carry)], itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 450 , weight(1.5)|abundance(30)|difficulty(3)|spd_rtng(100)|weapon_length(103)|swing_damage(24 , cut)|thrust_damage(0 ,  pierce), imodbits_sword_high ],

##### Tier 3 #####
["nomad_sabre",		"Nomad Sabre",		[("khergit_sword_b",0),("khergit_sword_b_scabbard", ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	750, weight(1.2)|abundance(25)|difficulty(2)|spd_rtng(110)|weapon_length(97)|swing_damage(26, cut),imodbits_sword_high ],
["eastern_sword",	"Eastern Sword",	[("saracin_sword_b",0),("scab_saracin_sword_b",ixmesh_carry)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	850, weight(1.5)|abundance(25)|difficulty(8)|spd_rtng(110)|weapon_length(89)|swing_damage(27, cut)|thrust_damage(19, pierce), imodbits_sword_high ],

##### Tier 4 #####
["sabre_a",					"Sabre",				[("khergit_sword_c",0),("khergit_sword_c_scabbard", ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	1250, weight(1.5)|abundance(12)|difficulty(2)|spd_rtng(110)|weapon_length(97)|swing_damage(29 , cut), imodbits_sword_high ],
["sabre_b",					"Sabre",				[("khergit_sword_a",0),("khergit_sword_a_scabbard", ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	1500, weight(1.5)|abundance(12)|difficulty(2)|spd_rtng(103)|weapon_length(98)|swing_damage(32 , cut), imodbits_sword_high ],
["eastern_long_sword_a",	"Eastern Long Sword",	[("saracin_sword_a",0),("scab_saracin_sword_a",ixmesh_carry)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	2000, weight(1.5)|abundance(12)|difficulty(8)|spd_rtng(95)|weapon_length(100)|swing_damage(29,cut)|thrust_damage(24,pierce), imodbits_sword_high ],
["eastern_long_sword_b",	"Eastern Long Sword",	[("saracin_sword_d",0),("scab_saracin_sword_d",ixmesh_carry)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	2250, weight(1.5)|abundance(12)|difficulty(8)|spd_rtng(91)|weapon_length(100)|swing_damage(30,cut)|thrust_damage(24,pierce), imodbits_sword_high ],

##### Tier 5 #####
["heavy_sabre",					"Heavy Sabre",				[("khergit_sword_d",0),("khergit_sword_d_scabbard", ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	3500, weight(1.75)|abundance(15)|difficulty(2)|spd_rtng(110)|weapon_length(96)|swing_damage(33, cut),imodbits_sword_high ],
["eastern_nobleman_sword_a",	"Eastern Nobleman Sword",	[("saracin_sword_e",0),("scab_saracin_sword_e",ixmesh_carry)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	3500, weight(1.5)|abundance(15)|difficulty(8)|spd_rtng(100)|weapon_length(102)|swing_damage(32,cut)|thrust_damage(26,pierce), imodbits_sword_high ],
["eastern_nobleman_sword_b",	"Eastern Nobleman Sword",	[("saracin_sword_c",0),("scab_saracin_sword_c",ixmesh_carry)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,	4500, weight(1.5)|abundance(15)|difficulty(8)|spd_rtng(95)|weapon_length(105)|swing_damage(33,cut)|thrust_damage(27,pierce), imodbits_sword_high ],

########## Sidearms ##########

##### Tier 1 #####
["sickle",	"Sickle",	[("sickle",0)],				itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_no_parry|itp_wooden_parry, itc_cleaver,				10, weight(1.5)|abundance(30)|difficulty(0)|spd_rtng(125)|weapon_length(40)|swing_damage(22 , cut)|thrust_damage(0,  pierce), imodbits_none ],
["cleaver",	"Cleaver",	[("cleaver_new",0)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_no_parry|itp_wooden_parry, itc_cleaver,				14, weight(1.5)|abundance(25)|difficulty(0)|spd_rtng(120)|weapon_length(35)|swing_damage(26 , cut)|thrust_damage(0,  pierce), imodbits_none ],
["knife",	"Knife",	[("peasant_knife_new",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_no_parry, itc_dagger|itcf_carry_dagger_front_left,	18, weight(0.5)|abundance(20)|difficulty(0)|spd_rtng(120)|weapon_length(40)|swing_damage(23 , cut)|thrust_damage(13,  pierce), imodbits_sword ],

##### Tier 2 #####
["long_knife",	"Long Knife",	[("khyber_knife_new",0)],																											itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_no_parry, itc_dagger|itcf_carry_dagger_front_right,								23, weight(0.75)|abundance(40)|difficulty(0)|spd_rtng(117)|weapon_length(60)|swing_damage(24 , cut)|thrust_damage(20 ,  pierce), imodbits_sword ],
["dagger",		"Dagger",		[("dagger_b",0),("dagger_b_scabbard",ixmesh_carry),("dagger_b",imodbits_good),("dagger_b_scabbard",ixmesh_carry|imodbits_good)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_no_parry, itc_dagger|itcf_carry_dagger_front_left|itcf_show_holster_when_drawn,	37, weight(0.75)|abundance(30)|difficulty(0)|spd_rtng(125)|weapon_length(47)|swing_damage(22 , cut)|thrust_damage(26 ,  pierce), imodbits_sword_high ],

##### Tier 3 #####
["war_dirk", "War Dirk",[("dirk",0),("dirk_scabbard", ixmesh_carry)], itp_type_one_handed_wpn|itp_primary, itc_dagger|itcf_carry_dagger_front_right|itcf_show_holster_when_drawn, 183, weight(1.25)|abundance(50)|difficulty(6)|spd_rtng(120)|weapon_length(55)|swing_damage(25 , cut)|thrust_damage(26, pierce),imodbits_sword ],

########## Mercenary ##########

["mercenary_sword_a",		"Mercenary Sword",			[("cheapsword1",0),("cheapswords1_scabbard",ixmesh_carry)],					itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 1500, weight(1.5)|abundance(10)|difficulty(8)|spd_rtng(109)|weapon_length(102)|swing_damage(18, cut)|thrust_damage(25,pierce), imodbits_sword_high ],
["mercenary_sword_b",		"Mercenary Sword",			[("cheapsword2",0),("cheapswords2_scabbard",ixmesh_carry)],					itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 1750, weight(1.5)|abundance(10)|difficulty(8)|spd_rtng(108)|weapon_length(102)|swing_damage(18, cut)|thrust_damage(26,pierce), imodbits_sword_high ],
["mercenary_sword_c",		"Mercenary Sword",			[("cheapsword3",0),("cheapswords3_scabbard",ixmesh_carry)],					itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 2000, weight(1.5)|abundance(10)|difficulty(8)|spd_rtng(106)|weapon_length(102)|swing_damage(20, cut)|thrust_damage(27,pierce), imodbits_sword_high ],
["mercenary_captain_sword", "Mercenary Captain Sword",	[("goodrapier1",0),("goodrapier1_scabbard",ixmesh_carry)],					itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 2500, weight(1.5)|abundance(10)|difficulty(8)|spd_rtng(104)|weapon_length(102)|swing_damage(23, cut)|thrust_damage(29,pierce), imodbits_sword_high ],
["broadsword_a",			"Broadsword",				[("goodsword1",0),("goodsword1_scabbard",ixmesh_carry)],					itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 3000, weight(1.5)|abundance(10)|difficulty(8)|spd_rtng(98)|weapon_length(97)|swing_damage(30, cut)|thrust_damage(17, pierce), imodbits_sword_high ],
["broadsword_b",			"Broadsword",				[("goodsword1",0),("goodsword1_scabbard",ixmesh_carry)],					itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 3500, weight(1.5)|abundance(10)|difficulty(8)|spd_rtng(97)|weapon_length(90)|swing_damage(31, cut)|thrust_damage(17, pierce), imodbits_sword_high ],
["broadsword_c",			"Broadsword",				[("highlad_broadsword",0),("highlad_broadsword_scabbard", ixmesh_carry)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 4000, weight(1.5)|abundance(10)|difficulty(9)|spd_rtng(99)|weapon_length(95)|swing_damage(33, cut)|thrust_damage(21, pierce), imodbits_sword_high, [], ],
...
##### Tier 1 #####
["short_axe", "Short Axe", [("bb_slavic_axe_1",0)],			itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,											25, weight(1.8)|abundance(100)|difficulty(3)|spd_rtng(104)|weapon_length(62)|swing_damage(19 ,pierce)|thrust_damage(0, pierce), imodbits_axe ],
["light_axe", "Light Axe", [("bb_slavic_cavalry_axe_1",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,											40, weight(1.9)|abundance(100)|difficulty(4)|spd_rtng(100)|weapon_length(75)|swing_damage(21 ,pierce)|thrust_damage(0, pierce), imodbits_axe ],

##### Tier 2 #####
["short_war_axe_a",	"Short War Axe",	[("axe_crusader_b",0)], itp_merchandise|itp_type_one_handed_wpn|itp_wooden_parry|itp_primary|itp_secondary|itp_bonus_against_shield, itc_scimitar|itcf_carry_axe_left_hip,				75, weight(1.8)|abundance(95)|difficulty(6)|spd_rtng(91)|weapon_length(64)|swing_damage(23, cut)|thrust_damage(0, pierce), imodbits_axe ],
["short_war_axe_b",	"Short War Axe",	[("axe_crusader_a",0)], itp_merchandise|itp_type_one_handed_wpn|itp_wooden_parry|itp_primary|itp_secondary|itp_bonus_against_shield, itc_scimitar|itcf_carry_axe_left_hip,				85, weight(1.8)|abundance(95)|difficulty(8)|spd_rtng(90)|weapon_length(66)|swing_damage(24, cut)|thrust_damage(0, pierce), imodbits_axe ],
["war_axe",			"War Axe",			[("axe_crusader_1",0)], itp_merchandise|itp_type_one_handed_wpn|itp_wooden_parry|itp_primary|itp_secondary|itp_bonus_against_shield, itc_scimitar|itcf_carry_axe_left_hip,				125, weight(2.5)|abundance(95)|difficulty(9)|spd_rtng(89)|weapon_length(80)|swing_damage(25, cut)|thrust_damage(0, pierce), imodbits_axe ],

##### Tier 3 #####
["military_sickle",	"Military Sickle",	[("military_sickle_a",0)],			itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,							150, weight(2.0)|abundance(75)|difficulty(9)|spd_rtng(88)|weapon_length(75)|swing_damage(26, pierce)|thrust_damage(0, pierce),imodbits_axe ],
["bearded_axe_a",	"Bearded Axe", 		[("axe_crusader_c",0)],				itp_merchandise|itp_type_one_handed_wpn|itp_wooden_parry|itp_primary|itp_secondary|itp_bonus_against_shield, itc_scimitar|itcf_carry_axe_left_hip,	175, weight(2.4)|abundance(75)|difficulty(10)|spd_rtng(87)|weapon_length(70)|swing_damage(28, cut)|thrust_damage(0, pierce), imodbits_axe ],
["bearded_axe_b",	"Bearded Axe",		[("axe_crusader_d",0)],				itp_merchandise|itp_type_one_handed_wpn|itp_wooden_parry|itp_primary|itp_secondary|itp_bonus_against_shield, itc_scimitar|itcf_carry_axe_left_hip,	225, weight(2.6)|abundance(75)|difficulty(11)|spd_rtng(86)|weapon_length(75)|swing_damage(29, cut)|thrust_damage(0, pierce), imodbits_axe ],
["battle_axe_a",	"Battle Axe",		[("one_handed_battle_axe_b",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,	275, weight(2.2)|abundance(75)|difficulty(12)|spd_rtng(76)|weapon_length(72)|swing_damage(33, cut)|thrust_damage(0, pierce), imodbits_axe ],
["battle_axe_b",	"Battle Axe",		[("one_handed_battle_axe_c",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,	300, weight(2.0)|abundance(75)|difficulty(13)|spd_rtng(74)|weapon_length(76)|swing_damage(34, cut)|thrust_damage(0, pierce), imodbits_axe ],

##### Tier 4 #####
["iron_battle_axe",	"Iron Battle Axe",	[("one_handed_battle_axe_g",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,	750, weight(3.0)|abundance(75)|difficulty(9)|spd_rtng(90) |weapon_length(71)|swing_damage(37, cut)|thrust_damage(0, pierce),imodbits_axe ],
["iron_war_axe",	"Iron War Axe",		[("one_handed_battle_axe_h",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,							950, weight(4.0)|abundance(75)|difficulty(9)|spd_rtng(92) |weapon_length(71)|swing_damage(34, pierce)|thrust_damage(0, pierce),imodbits_axe ],
...
#["one_handed_war_axe_c", "One Handed Axe", [("one_handed_war_axe_a",0)], itp_type_one_handed_wpn|itp_merchandise| itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip, 87 , weight(1.5)|difficulty(9)|spd_rtng(98) | weapon_length(71)|swing_damage(32 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
...
########## One-handed ##########
["wooden_stick",	"Wooden Stick",	[("wooden_stick",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_scimitar,						10, weight(2.5)|abundance(100)|difficulty(0)|spd_rtng(107)|weapon_length(63)|swing_damage(14 , blunt)|thrust_damage(0 ,  pierce),imodbits_none ],
["club",			"Club",			[("club",0)],			itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_scimitar,						12, weight(2.5)|abundance(95)|difficulty(0)|spd_rtng(103)|weapon_length(70)|swing_damage(15 , blunt)|thrust_damage(0 ,  pierce),imodbits_none ],
["spiked_club_a",	"Spiked Club",	[("spiked_club",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,				25, weight(1.9)|abundance(90)|difficulty(2)|spd_rtng(97)|weapon_length(70)|swing_damage(15 , pierce)|thrust_damage(0 ,  pierce),imodbits_mace ],
["spiked_club_b",	"Spiked Club",	[("mace_d",0)],			itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,				35, weight(1.5)|abundance(90)|difficulty(3)|spd_rtng(99)|weapon_length(70)|swing_damage(16 , pierce)|thrust_damage(0 ,  pierce),imodbits_mace ],

["knobbed_mace",	"Knobbed_Mace",	[("mace_a",0)],						itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,	750, weight(2.5)|abundance(80)|difficulty(6)|spd_rtng(100)|weapon_length(70)|swing_damage(17, blunt)|thrust_damage(0 ,  pierce), imodbits_mace ],
["spiked_mace",		"Spiked Mace",	[("spiked_mace_new",0)],			itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,	850, weight(3.5)|abundance(80)|difficulty(7)|spd_rtng(100)|weapon_length(70)|swing_damage(18, blunt)|thrust_damage(0 ,  pierce), imodbits_pick ],
["flanged_mace",	"Flanged Mace",	[("bb_serbian_knobbed_mace_3",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,	950, weight(1.2)|abundance(80)|difficulty(8)|spd_rtng(104)|weapon_length(67)|swing_damage(19, blunt)|thrust_damage(0 ,  pierce), imodbits_mace ],

["pickaxe",			"Pickaxe",			[("fighting_pick_new",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,		1750, weight(3.0)|abundance(70)|difficulty(10)|spd_rtng(82)|weapon_length(70)|swing_damage(21 , pierce)|thrust_damage(0 ,  pierce), imodbits_pick ],
["fighting_pick",	"Fighting Pick",	[("fighting_pick_new",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,		2250, weight(2.9)|abundance(70)|difficulty(12)|spd_rtng(80)|weapon_length(70)|swing_damage(22 , pierce)|thrust_damage(0 ,  pierce), imodbits_pick ],
["winged_mace",		"Winged_Mace",		[("mace_b",0)],				itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,		2750, weight(2.7)|abundance(70)|difficulty(14)|spd_rtng(78)|weapon_length(70)|swing_damage(21 , blunt)|thrust_damage(0 ,  pierce), imodbits_mace ],


["military_pick",	"Military Pick",	[("steel_pick_new",0)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,		4000, weight(1.5)|abundance(50)|difficulty(15)|spd_rtng(80)|weapon_length(70)|swing_damage(26 , pierce)|thrust_damage(0,  pierce), imodbits_pick ],
["war_hammer",		"War Hammer",		[("faradon_warhammer",0)],	itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_longsword|itcf_carry_sword_left_hip,		5000, weight(1.5)|abundance(40)|difficulty(16)|spd_rtng(79)|weapon_length(73)|swing_damage(28 , blunt)|thrust_damage(0,  pierce), imodbits_mace ],
["iron_mace",		"Iron Mace",		[("mace_small_d",0)],		itp_merchandise|itp_type_one_handed_wpn|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,		6000, weight(2.0)|abundance(30)|difficulty(17)|spd_rtng(76)|weapon_length(73)|swing_damage(31 , blunt)|thrust_damage(0,  pierce), imodbits_mace ],
...
#["winged_mace_old",         "Flanged Mace", [("flanged_mace",0)], itp_type_one_handed_wpn|itp_can_knock_down|itp_merchandise| itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip, 122 , weight(3.5)|difficulty(2)|spd_rtng(103) | weapon_length(70)|swing_damage(24 , blunt) | thrust_damage(0 ,  pierce),imodbits_mace ],
...
["great_sword",				"Great Sword",			[("b_bastard_sword",0),("scab_bastardsw_b", ixmesh_carry)],	itp_merchandise|itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back|itcf_show_holster_when_drawn,		1500, weight(2.75)|abundance(20)|difficulty(10)|spd_rtng(115)|weapon_length(125)|swing_damage(22, cut)|thrust_damage(32, pierce),imodbits_sword_high ],
["two_handed_cleaver",		"Two Handed Cleaver",	[("military_cleaver_a",0)],									itp_merchandise|itp_type_two_handed_wpn|itp_merchandise|itp_two_handed|itp_primary, itc_nodachi|itcf_carry_sword_back,						2000, weight(2.75)|abundance(17)|difficulty(10)|spd_rtng(97)|weapon_length(120)|swing_damage(35, cut)|thrust_damage(0, pierce),imodbits_sword_high ],
["two_handed_sabre",		"Two Handed Sabre",		[("khergit_sword_two_handed_a",0)],							itp_merchandise|itp_type_two_handed_wpn|itp_merchandise|itp_two_handed|itp_primary, itc_nodachi|itcf_carry_sword_back,						2500, weight(2.75)|abundance(15)|difficulty(10)|spd_rtng(95)|weapon_length(120)|swing_damage(43, cut)|thrust_damage(0, pierce),imodbits_sword_high ],
["claymore",				"Claymore",				[("2h_claymore",0)],										itp_merchandise|itp_type_two_handed_wpn|itp_merchandise|itp_primary, itc_bastardsword|itcf_carry_sword_back,								3000, weight(2.65)|abundance(13)|difficulty(13)|spd_rtng(110)|weapon_length(101)|swing_damage(37, cut)|thrust_damage(45, pierce),imodbits_sword_high ],
["flamberge",				"Flamberge Zweihander",	[("flamberge",0)],											itp_merchandise|itp_type_two_handed_wpn|itp_merchandise|itp_two_handed|itp_next_item_as_melee|itp_primary, itc_staff|itcf_carry_sword_back,	3500, weight(3.75)|abundance(11)|difficulty(11)|spd_rtng(112)|weapon_length(135)|swing_damage(45, cut)|thrust_damage(34, pierce),imodbits_sword_high ],
["flamberge_alt",			"Flamberge Zweihander",	[("flamberge",0)],											itp_type_polearm|itp_merchandise|itp_always_loot|itp_two_handed|itp_primary, itc_staff|itcf_carry_sword_back,								3500, weight(3.75)|abundance(9)|difficulty(11)|spd_rtng(117)|weapon_length(145)|swing_damage(25, cut)|thrust_damage(55, pierce),imodbits_sword_high ],
["sword_of_the_stag",		"Sword of The Stag",	[("faradon_twohanded2",0)],									itp_merchandise|itp_type_two_handed_wpn|itp_cant_use_on_horseback|itp_primary, itc_greatsword|itcf_carry_sword_back,						4500, weight(3.95)|abundance(7)|difficulty(15)|spd_rtng(110)|weapon_length(118)|swing_damage(45, cut)|thrust_damage(50, pierce),imodbits_sword_high ],
...
#["flamberge_b",  "Flamberge Zweihander", [("flamberge",0)], itp_type_two_handed_wpn|itp_merchandise|itp_crush_through|itp_unbalanced|itp_always_loot|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back, 1123 , weight(4.75)|abundance(15)|difficulty(11)|spd_rtng(84) | weapon_length(148)|swing_damage(45, cut) | thrust_damage(28 ,  pierce),imodbits_sword_high ],


########## Two-handed Axes ##########
["long_axe",			"Long Axe",			[("long_axe_a",0)],	itp_merchandise|itp_type_polearm|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry|itp_next_item_as_melee, itc_staff|itcf_carry_axe_back,	250, weight(4.75)|abundance(70)|difficulty(12)|spd_rtng(100)|weapon_length(120)|swing_damage(32, cut)|thrust_damage(17,  blunt),imodbits_axe ],
["long_axe_alt",		"Long Axe",			[("long_axe_a",0)],	itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back,									250, weight(4.75)|abundance(70)|difficulty(12)|spd_rtng(90)|weapon_length(120)|swing_damage(36, cut)|thrust_damage(0,  pierce),imodbits_axe ],
["long_war_axe",		"Long War Axe",		[("long_axe_b",0)],	itp_merchandise|itp_type_polearm|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry|itp_next_item_as_melee, itc_staff|itcf_carry_axe_back,	350, weight(5.25)|abundance(55)|difficulty(13)|spd_rtng(98)|weapon_length(125)|swing_damage(36, cut)|thrust_damage(18,  blunt),imodbits_axe ],
["long_war_axe_alt",	"Long War Axe",		[("long_axe_b",0)],	itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back,									350, weight(5.25)|abundance(55)|difficulty(13)|spd_rtng(88)|weapon_length(125)|swing_damage(40, cut)|thrust_damage(0,  pierce),imodbits_axe ],
["great_long_axe",		"Great Long Axe",	[("long_axe_c",0)],	itp_merchandise|itp_type_polearm|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry|itp_next_item_as_melee, itc_staff|itcf_carry_axe_back,	450, weight(5.75)|abundance(40)|difficulty(13)|spd_rtng(96)|weapon_length(127)|swing_damage(41, cut)|thrust_damage(19,  blunt),imodbits_axe ],
["great_long_axe_alt",	"Great Long Axe",	[("long_axe_c",0)],	itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back,									450, weight(5.75)|abundance(40)|difficulty(13)|spd_rtng(86)|weapon_length(127)|swing_damage(44, cut)|thrust_damage(0,  pierce),imodbits_axe ],
["great_voulge",		"Great Voulge",		[("voulge",0)],		itp_merchandise|itp_unbalanced|itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back,							600, weight(4.75)|abundance(30)|difficulty(15)|spd_rtng(85)|weapon_length(119)|swing_damage(45, cut)|thrust_damage(0,  pierce),imodbits_axe ],
["great_axe",			"Great Axe",		[("great_ax",0)],	itp_merchandise|itp_unbalanced|itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back,	415, weight(7.50)|abundance(80)|difficulty(13)|spd_rtng(82)|weapon_length(120)|swing_damage(45, cut)|thrust_damage(0, pierce), imodbits_axe ],
...
#["war_axe_b",         "War Axe", [("war_ax",0)], itp_type_two_handed_wpn|itp_merchandise| itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 264 , weight(5)|difficulty(12)|spd_rtng(86) | weapon_length(110)|swing_damage(43 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
...
########## Two-handed Maces ##########
["long_spiked_club",			"Long Spiked Club",		[("mace_long_c",0)],			itp_merchandise|itp_type_two_handed_wpn|itp_two_handed|itp_can_knock_down|itp_primary|itp_wooden_parry, itc_greatsword|itcf_carry_axe_back,													110 , weight(3.2)|abundance(50)|difficulty(4)|spd_rtng(105)|weapon_length(108)|swing_damage(17, blunt)|thrust_damage(13, blunt), imodbits_mace ],
["war_club",					"War Club",				[("faradon_largeclub",0)],		itp_merchandise|itp_type_two_handed_wpn|itp_two_handed|itp_can_knock_down|itp_primary|itp_wooden_parry, itc_greatsword|itcf_carry_sword_left_hip,											150 , weight(3.5)|abundance(40)|difficulty(7)|spd_rtng(109)|weapon_length(87)|swing_damage(22, blunt)|thrust_damage(18, blunt), imodbits_mace ],

["goedendag",					"Goedendag",			[("mace_e",0)],					itp_merchandise|itp_type_two_handed_wpn|itp_two_handed|itp_can_knock_down|itp_primary|itp_wooden_parry, itc_greatsword|itcf_carry_axe_back,													200, weight(2)|abundance(40)|difficulty(9)|spd_rtng(108)|weapon_length(117)|swing_damage(24 , blunt)|thrust_damage(20, pierce), imodbits_mace ],
["maul",						"Maul",					[("maul_b",0)],					itp_merchandise|itp_crush_through|itp_type_two_handed_wpn|itp_can_knock_down|itp_primary|itp_two_handed|itp_wooden_parry|itp_wooden_attack|itp_unbalanced, itc_nodachi|itcf_carry_spear,	225, weight(6)|abundance(35)|difficulty(15)|spd_rtng(83)|weapon_length(79)|swing_damage(36 , blunt)|thrust_damage(0, pierce), imodbits_mace ],
["sledgehammer",				"Sledgehammer",			[("maul_c",0)],					itp_merchandise|itp_crush_through|itp_type_two_handed_wpn|itp_can_knock_down|itp_primary|itp_two_handed|itp_wooden_parry|itp_wooden_attack|itp_unbalanced, itc_nodachi|itcf_carry_spear,	250, weight(7)|abundance(35)|difficulty(16)|spd_rtng(81)|weapon_length(82)|swing_damage(39, blunt)|thrust_damage(0, pierce), imodbits_mace ],

["great_hammer",				"Great Hammer",			[("maul_d",0)],					itp_merchandise|itp_crush_through|itp_type_two_handed_wpn|itp_can_knock_down|itp_primary|itp_two_handed|itp_wooden_parry|itp_wooden_attack|itp_unbalanced, itc_nodachi|itcf_carry_spear,	375, weight(9)|abundance(30)|difficulty(17)|spd_rtng(79)|weapon_length(75)|swing_damage(45 , blunt)|thrust_damage(0, pierce), imodbits_mace ],
["morningstar",					"Morningstar",			[("mace_morningstar_new",0)],	itp_merchandise|itp_crush_through|itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_wooden_parry|itp_unbalanced, itc_greatsword|itcf_carry_mace_left_hip,								950, weight(4.5)|abundance(25)|difficulty(13)|spd_rtng(95)|weapon_length(85)|swing_damage(49 , pierce)|thrust_damage(0, pierce), imodbits_mace ],

["iron_war_mace",				"Iron War Mace",		[("mace_long_d",0)],			itp_merchandise|itp_type_two_handed_wpn|itp_can_knock_down|itp_two_handed|itp_primary|itp_crush_through|itp_unbalanced, itc_greatsword|itcf_carry_axe_back,									470, weight(6)|abundance(10)|difficulty(16)|spd_rtng(85)|weapon_length(95)|swing_damage(45 , blunt)|thrust_damage(22, blunt), imodbits_mace ],
...
########## Spears ##########
##### Tier 1 #####
["pitch_fork",		"Pitch Fork",		[("pitch_fork",0)],			itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_can_penetrate_shield|itp_bonus_against_shield, itc_staff|itcf_carry_spear,	19, weight(1.55)|abundance(100)|difficulty(0)|spd_rtng(125)|weapon_length(154)|swing_damage(16, blunt)|thrust_damage(20, pierce), imodbits_polearm ],
["scythe",			"Scythe",			[("scythe",0)],				itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_can_penetrate_shield|itp_bonus_against_shield, itc_staff|itcf_carry_spear,	35, weight(2.55)|abundance(100)|difficulty(0)|spd_rtng(122)|weapon_length(182)|swing_damage(24, cut) |thrust_damage(16, pierce), imodbits_polearm ],
##### Tier 2 #####
["peasant_spear",	"Peasant Spear",	[("crusader_spear_b",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_can_penetrate_shield|itp_bonus_against_shield, itc_staff|itcf_carry_spear,	45, weight(2.25)|abundance(90)|difficulty(1)|spd_rtng(120)|weapon_length(190)|swing_damage(22, cut)|thrust_damage(25, pierce), imodbits_polearm ],
["boar_spear",		"Boar Spear",		[("spear",0)],				itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry|itp_can_penetrate_shield|itp_bonus_against_shield, itc_staff|itcf_carry_spear,											55, weight(1.55)|abundance(90)|difficulty(3)|spd_rtng(118)|weapon_length(157)|swing_damage(28, cut)|thrust_damage(24, pierce), imodbits_polearm ],
["short_spear",		"Short Spear",		[("spear_g_1-9m",0)],		itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry|itp_can_penetrate_shield|itp_bonus_against_shield, itc_staff|itcf_carry_spear,											53, weight(1.25)|abundance(90)|difficulty(2)|spd_rtng(130)|weapon_length(120)|swing_damage(22, blunt)|thrust_damage(27, pierce), imodbits_polearm ],
##### Tier 3 #####
["cutting_spear",	"Cutting Spear",	[("crusader_spear_a",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_can_penetrate_shield|itp_bonus_against_shield, itc_staff|itcf_carry_spear,	102, weight(2.2)|abundance(85)|difficulty(5)|spd_rtng(110)|weapon_length(190)|swing_damage(30, cut)|thrust_damage(27, pierce), imodbits_polearm ],
["winged_spear",	"Winged Spear",		[("mameluk_spears_b",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_can_penetrate_shield|itp_bonus_against_shield, itc_staff|itcf_carry_spear,	175, weight(2.2)|abundance(85)|difficulty(7)|spd_rtng(110)|weapon_length(190)|swing_damage(30, cut)|thrust_damage(30, pierce), imodbits_polearm ],
["awlpike",			"Awlpike",			[("awl_pike_b",0)],			itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_can_penetrate_shield, itc_cutting_spear|itcf_carry_spear,					195, weight(1.2)|abundance(85)|difficulty(8)|spd_rtng(105)|weapon_length(165)|swing_damage(28, blunt)|thrust_damage(34 ,  pierce), imodbits_polearm ],

##### Tier 4 #####
["infantry_spear",	"Infantry Spear",	[("crusader_spear_c",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_can_penetrate_shield|itp_bonus_against_shield, itc_staff|itcf_carry_spear,	225, weight(2.2)|abundance(80)|difficulty(9)|spd_rtng(103)|weapon_length(190)|swing_damage(25, blunt)|thrust_damage(37, pierce), imodbits_polearm ],
["awlpike_long",	"Long Awlpike",		[("awl_pike_a",0)],			itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_can_penetrate_shield|itp_two_handed, itc_cutting_spear|itcf_carry_spear,	385, weight(2.4)|abundance(80)|difficulty(9)|spd_rtng(100)|weapon_length(185)|swing_damage(32 , blunt)|thrust_damage(35, pierce), imodbits_polearm ],



#["trident_spear", "Remove", [("mameluk_spears_a",0)], itp_type_polearm|itp_merchandise|itp_wooden_parry|itp_primary|itp_offset_lance, itc_staff|itcf_carry_spear, 150, weight(2.25)|difficulty(8)|spd_rtng(106)|weapon_length(190)|swing_damage(24,blunt)|thrust_damage(27,pierce), imodbits_polearm, [], [fac_kingdom_1,fac_kingdom_2] ],
#["military_fork", "Remove", [("military_fork",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry,itc_staff, 153 , weight(2)|difficulty(0)|spd_rtng(95) | weapon_length(135)|swing_damage(15 , blunt) | thrust_damage(30 ,  pierce),imodbits_polearm ],
#["battle_fork",         "Remove", [("battle_fork",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry,itc_staff, 282 , weight(2.2)|difficulty(0)|spd_rtng(90) | weapon_length(144)|swing_damage(15, blunt) | thrust_damage(35 ,  pierce),imodbits_polearm ],
#["spear",         "Remove", [("spear_h_2-15m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 85 , weight(2.25)|difficulty(2)|spd_rtng(98) | weapon_length(135)|swing_damage(20 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm, [], [fac_kingdom_1, fac_kingdom_2]],
#["bamboo_spear",         "Remove", [("arabian_spear_a_3m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_staff|itcf_carry_spear, 80 , weight(2.0)|difficulty(2)|spd_rtng(88) | weapon_length(200)|swing_damage(15 , blunt) | thrust_damage(20 ,  pierce),imodbits_polearm ],
#["war_spear",         "Remove", [("spear_i_2-3m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 140 , weight(2.5)|difficulty(3)|spd_rtng(115) | weapon_length(150)|swing_damage(20 , blunt) | thrust_damage(27 ,  pierce),imodbits_polearm ],
#["mod_hookedspear1", "Remove", [("bb_serbian_hooked_spear_1",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_staff,  495 , weight(2.5)|difficulty(4)|spd_rtng(96) | weapon_length(132)|swing_damage(28, pierce) | thrust_damage(26 ,  pierce),imodbits_polearm ],
#["mod_hookedspear2", "Remove", [("bb_serbian_hooked_spear_2",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_staff,  485 , weight(2.4)|difficulty(4)|spd_rtng(95) | weapon_length(130)|swing_damage(27, pierce) | thrust_damage(25 ,  pierce),imodbits_polearm ],

########## Pikes #########

["pike",				"Pike", [("spear_a_3m",0)],			itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_bonus_against_shield|itp_unbalanced, itc_pike, 350, weight(3)|abundance(40)|difficulty(10)|spd_rtng(107)|weapon_length(260)|swing_damage(0, blunt)|thrust_damage(45, pierce), imodbits_polearm ],
["heavy_pike",			"Heavy Pike", [("bb_rus_pike",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_bonus_against_shield|itp_unbalanced, itc_pike, 450, weight(4)|abundance(30)|difficulty(12)|spd_rtng(105)|weapon_length(275)|swing_damage(0, blunt)|thrust_damage(52, pierce), imodbits_polearm ],
["mercenary_pike",		"Mercenary Pike", [("pike1",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry|itp_bonus_against_shield|itp_unbalanced, itc_pike, 600, weight(6)|abundance(20)|difficulty(15)|spd_rtng(100)|weapon_length(430)|swing_damage(0, blunt)|thrust_damage(33, pierce), imodbits_polearm ],

#["mercenary_pike_b",	"Mercenary Pike", [("pike2",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 600, weight(6)|difficulty(15)|spd_rtng(100)|weapon_length(430)|swing_damage(25,blunt)|thrust_damage(45,pierce), imodbits_polearm ],
...
##### Tier 4 #####
["knightly_lance_a",	"Knightly Lance",	[("lance_4",0)],					itp_merchandise|itp_type_polearm|itp_couchable|itp_primary|itp_offset_lance|itp_penalty_with_shield|itp_wooden_parry, itc_greatlance,		850, weight(5.5)|abundance(10)|difficulty(15)|spd_rtng(90)|weapon_length(230)|swing_damage(34, cut)|thrust_damage(34, pierce), imodbits_polearm ],
["knightly_lance_b",	"Knightly Lance",	[("lance_5",0)],					itp_merchandise|itp_type_polearm|itp_couchable|itp_primary|itp_offset_lance|itp_penalty_with_shield|itp_wooden_parry, itc_greatlance, 		850, weight(5.5)|abundance(10)|difficulty(15)|spd_rtng(90)|weapon_length(230)|swing_damage(34, cut)|thrust_damage(34, pierce), imodbits_polearm ],
...
########## Poleaxes ##########
##### Tier 1 #####
["staff",						"Staff",					[("wooden_staff",0)],					itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 12, weight(1.7)|abundance(100)|difficulty(2)|spd_rtng(114)|weapon_length(130)|swing_damage(15, blunt)|thrust_damage(14, blunt), imodbits_polearm ],
["quarter_staff",				"Quarter Staff",			[("quarter_staff",0)],					itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 17, weight(2.2)|abundance(95)|difficulty(3)|spd_rtng(110)|weapon_length(140)|swing_damage(17, blunt)|thrust_damage(16, blunt), imodbits_polearm ],
##### Tier 2 ##### 
["long_hafted_knobbed_mace",	"Long-hafted Knobbed Mace",	[("mace_long_a",0)],					itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 75, weight(3.2)|abundance(75)|difficulty(4)|spd_rtng(95)|weapon_length(133)|swing_damage(21, blunt)|thrust_damage(21, blunt), imodbits_polearm ],
["long_hafted_spiked_mace",		"Long-hafted Spiked Mace",	[("mace_long_b",0)],					itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 85, weight(3.2)|abundance(65)|difficulty(4)|spd_rtng(94)|weapon_length(140)|swing_damage(23, blunt)|thrust_damage(23, blunt), imodbits_polearm ],
["military_scythe",				"Military Scythe",			[("spear_e_2-5m",0)],					itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 95, weight(2.2)|abundance(55)|difficulty(3)|spd_rtng(90)|weapon_length(155)|swing_damage(29, cut)|thrust_damage(27, pierce), imodbits_polearm ],
##### Tier 3 #####
["hafted_blade_b",				"Hafted Blade",				[("khergit_pike_b",0)],					itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 150, weight(2.2)|abundance(40)|difficulty(10)|spd_rtng(105)|weapon_length(135)|swing_damage(33, cut)|thrust_damage(35, cut), imodbits_polearm ],
["hafted_blade_a",				"Hafted Blade",				[("khergit_pike_a",0)],					itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 175, weight(3.2)|abundance(35)|difficulty(11)|spd_rtng(100)|weapon_length(153)|swing_damage(35, cut)|thrust_damage(36, cut), imodbits_polearm ],
["glaive",						"Glaive",					[("glaive_b",0)],						itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 200, weight(4.2)|abundance(40)|difficulty(10)|spd_rtng(99)|weapon_length(157)|swing_damage(36, cut)|thrust_damage(35, cut), imodbits_polearm ],
["bill",						"Bill",						[("luc_bill_guisarme_long_n",0)],		itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 225, weight(4.5)|abundance(35)|difficulty(12)|spd_rtng(90)|weapon_length(212)|swing_damage(30, pierce)|thrust_damage(30, pierce), imodbits_polearm ],
["voulge",						"Voulge",					[("two_handed_battle_long_axe_a",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 250, weight(3.5)|abundance(33)|difficulty(11)|spd_rtng(90)|weapon_length(175)|swing_damage(37, cut)|thrust_damage(25, pierce), imodbits_polearm ],
["long_bardiche",				"Long Bardiche",			[("two_handed_battle_long_axe_b",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 275, weight(4.2)|abundance(28)|difficulty(12)|spd_rtng(90)|weapon_length(140)|swing_damage(40, cut)|thrust_damage(17, pierce), imodbits_polearm ],
##### Tier 4 #####
["great_long_bardiche",			"Great Long Bardiche",		[("two_handed_battle_long_axe_c",0)],	itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 500, weight(5)|abundance(20)|difficulty(15)|spd_rtng(85)|weapon_length(155)|swing_damage(44, cut)|thrust_damage(18, pierce), imodbits_polearm ],
["poleaxe",						"Poleaxe",					[("pole_ax",0)],						itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 575, weight(4)|abundance(15)|difficulty(15)|spd_rtng(91)|weapon_length(180)|swing_damage(47, cut)|thrust_damage(25, blunt), imodbits_polearm ],
["pole_hammer",					"Pole Hammer",				[("bec_de_corbin_a",0)],				itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 650, weight(3)|abundance(10)|difficulty(14)|spd_rtng(91)|weapon_length(135)|swing_damage(33, blunt)|thrust_damage(35 , pierce), imodbits_polearm ],
##### Tier 5 #####
["poleaxe_of_the_order",		"Poleaxe of The Order",		[("weapon_1",0)],						itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 3500, weight(4)|abundance(1)|difficulty(14)|spd_rtng(90)|weapon_length(190)|swing_damage(51, cut)| thrust_damage(30, pierce), imodbits_polearm ],
["staghammer",					"Staghammer",				[("staghammer",0)],						itp_merchandise|itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff, 5000, weight(7)|abundance(1)|difficulty(15)|spd_rtng(92)|weapon_length(175)|swing_damage(38, blunt)|thrust_damage(37, pierce), imodbits_polearm ],
...
["stones",				"Stones", [("throwing_stone",0)],				itp_type_thrown|itp_merchandise|itp_primary ,itcf_throw_stone, 1 , weight(4)|abundance(100)|difficulty(0)|spd_rtng(97) | shoot_speed(30) | thrust_damage(24 ,  blunt)|max_ammo(35)|weapon_length(8),imodbit_large_bag ],
["throwing_knives",		"Throwing Knives", [("throwing_knife",0)],		itp_type_thrown|itp_merchandise|itp_primary ,itcf_throw_knife, 76 , weight(2.5)|abundance(40)|difficulty(1)|spd_rtng(121) | shoot_speed(25) | thrust_damage(29 ,  cut)|max_ammo(28)|weapon_length(0),imodbits_thrown ],
["throwing_daggers",	"Throwing Daggers", [("throwing_dagger",0)],	itp_type_thrown|itp_merchandise|itp_primary ,itcf_throw_knife, 193 , weight(2.5)|abundance(25)|difficulty(1)|spd_rtng(110) | shoot_speed(24) | thrust_damage(32 ,  cut)|max_ammo(30)|weapon_length(0),imodbits_thrown ],

########### Darts ##########

["darts",		"Darts", [("dart_b",0),("dart_b_bag", ixmesh_carry)],		itp_type_thrown|itp_merchandise|itp_primary ,itcf_throw_javelin|itcf_carry_quiver_right_vertical|itcf_show_holster_when_drawn,	155, weight(2)|abundance(80)|difficulty(0)|spd_rtng(105) | shoot_speed(28) | thrust_damage(28 ,  pierce)|max_ammo(20)|weapon_length(32),imodbits_thrown ],
["war_darts",	"War Darts", [("dart_a",0),("dart_a_bag", ixmesh_carry)],	itp_type_thrown|itp_merchandise|itp_primary ,itcf_throw_javelin|itcf_carry_quiver_back|itcf_show_holster_when_drawn,			285, weight(2)|abundance(70)|difficulty(1)|spd_rtng(102) | shoot_speed(27) | thrust_damage(31 ,  pierce)|max_ammo(22)|weapon_length(45),imodbits_thrown ],

########### Javelins ##########

["javelin",					"Javelins", [("javelin",0),("javelins_quiver_new", ixmesh_carry)],			itp_type_thrown |itp_merchandise|itp_primary|itp_next_item_as_melee ,itcf_throw_javelin|itcf_carry_quiver_back|itcf_show_holster_when_drawn,					300, weight(4)|abundance(75)|difficulty(2)|spd_rtng(91) | shoot_speed(25) | thrust_damage(38 ,  pierce)|max_ammo(10)|weapon_length(75),imodbits_thrown ],
...
["light_throwing_axes",			"Light Throwing Axes", [("francisca",0)],		itp_type_thrown |itp_merchandise|itp_primary|itp_next_item_as_melee,itcf_throw_axe,		360, weight(3)|abundance(75)|difficulty(1)|spd_rtng(99) | shoot_speed(18) | thrust_damage(40,cut)|max_ammo(14)|weapon_length(53),imodbits_thrown_minus_heavy ],
...
["throwing_axes",				"Throwing Axes", [("throwing_axe_a",0)],		itp_type_thrown |itp_merchandise|itp_primary|itp_next_item_as_melee,itcf_throw_axe,		490, weight(5)|abundance(50)|difficulty(2)|spd_rtng(98) | shoot_speed(18) | thrust_damage(45,cut)|max_ammo(12)|weapon_length(53),imodbits_thrown_minus_heavy ],
...
["heavy_throwing_axes",			"Heavy Throwing Axes", [("throwing_axe_b",0)],	itp_type_thrown |itp_merchandise|itp_primary|itp_next_item_as_melee,itcf_throw_axe,		620, weight(7)|abundance(25)|difficulty(4)|spd_rtng(97) | shoot_speed(18) | thrust_damage(53,cut)|max_ammo(10)|weapon_length(53),imodbits_thrown_minus_heavy ],
...
########### Bows ##########
["light_hunting_bow",	"Light Hunting Bow",	[("saracin_bow_a",0),("saracin_bow_case_a",ixmesh_carry)],	itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,	15, weight(1)|abundance(100)|difficulty(0)|spd_rtng(110)|shoot_speed(52)|thrust_damage(24, cut), imodbits_bow ],
["hunting_bow",			"Hunting Bow",			[("hunting_bow",0),("hunting_bow_carry",ixmesh_carry)],		itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bow_back,									25, weight(1)|abundance(100)|difficulty(0)|spd_rtng(100)|shoot_speed(52) | thrust_damage(28,  cut), imodbits_bow ],
["short_bow",			"Short Bow",			[("short_bow",0),("short_bow_carry",ixmesh_carry)],			itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bow_back,									50, weight(1)|abundance(90)|difficulty(1)|spd_rtng(97)|shoot_speed(55) | thrust_damage(35,  cut), imodbits_bow ],
["nomad_bow",			"Nomad Bow",			[("nomad_bow",0),("nomad_bow_case", ixmesh_carry)],			itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,	150, weight(1.25)|abundance(80)|difficulty(2)|spd_rtng(94)|shoot_speed(56) | thrust_damage(18,  pierce), imodbits_bow ],
["long_bow",			"Long Bow",				[("long_bow",0),("long_bow_carry",ixmesh_carry)],			itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bow_back,									175, weight(1.75)|abundance(75)|difficulty(3)|spd_rtng(79)|shoot_speed(56) | thrust_damage(21,  pierce), imodbits_bow ],
["light_war_bow",		"Light War Bow",		[("saracin_bow_b",0),("saracin_bow_case_b",ixmesh_carry)],	itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,	250, weight(1.75)|abundance(65)|difficulty(0)|spd_rtng(88)|shoot_speed(63)|thrust_damage(23, pierce), imodbits_bow ],
["khergit_bow",			"Khergit Bow",			[("khergit_bow",0),("khergit_bow_case", ixmesh_carry)],		itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,	300, weight(1.25)|abundance(45)|difficulty(2)|spd_rtng(90)|shoot_speed(57) | thrust_damage(24, pierce), imodbits_bow ],
["strong_bow",			"Strong Bow",			[("strong_bow",0),("strong_bow_case", ixmesh_carry)],		itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,	450, weight(1.25)|abundance(25)|difficulty(3)|spd_rtng(88)|shoot_speed(60) | thrust_damage(26, pierce), imodbits_bow ],
["war_bow",				"War Bow",				[("war_bow",0),("war_bow_carry",ixmesh_carry)],				itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bow_back,									750, weight(1.5)|abundance(15)|difficulty(4)|spd_rtng(84)|shoot_speed(65) | thrust_damage(28, pierce), imodbits_bow ],
["heavy_war_bow",		"Heavy War Bow",		[("saracin_bow_c",0),("saracin_bow_case_c",ixmesh_carry)],	itp_merchandise|itp_type_bow|itp_primary|itp_two_handed, itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,	1000, weight(2.25)|abundance(1)|difficulty(7)|spd_rtng(80)|shoot_speed(70)|thrust_damage(30, pierce), imodbits_bow ],
...
["hunting_crossbow",	"Hunting Crossbow",	[("crossbow_a",0)], itp_merchandise|itp_type_crossbow|itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back,									22 , weight(2.25)|abundance(75)|difficulty(2)|spd_rtng(47) | shoot_speed(62) | thrust_damage(37 ,  pierce)|max_ammo(1),imodbits_crossbow ],
["light_crossbow",		"Light Crossbow",	[("crossbow_b",0)], itp_merchandise|itp_type_crossbow|itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back,									67 , weight(2.5)|abundance(70)|difficulty(3)|spd_rtng(45) | shoot_speed(70) | thrust_damage(44 ,  pierce)|max_ammo(1),imodbits_crossbow ],
["crossbow",			"Crossbow",			[("crossbow_a",0)], itp_merchandise|itp_type_crossbow|itp_primary|itp_two_handed|itp_cant_reload_on_horseback ,itcf_shoot_crossbow|itcf_carry_crossbow_back,	182 , weight(3)|abundance(65)|difficulty(3)|spd_rtng(43) | shoot_speed(78) | thrust_damage(49,pierce)|max_ammo(1),imodbits_crossbow ],
["heavy_crossbow",		"Heavy Crossbow",	[("crossbow_c",0)], itp_merchandise|itp_type_crossbow|itp_primary|itp_two_handed|itp_cant_reload_on_horseback ,itcf_shoot_crossbow|itcf_carry_crossbow_back,	349 , weight(3.5)|abundance(35)|difficulty(5)|spd_rtng(33) | shoot_speed(82) | thrust_damage(54 ,pierce)|max_ammo(1),imodbits_crossbow ],
["sniper_crossbow",		"Siege Crossbow",	[("crossbow_c",0)], itp_merchandise|itp_type_crossbow|itp_primary|itp_two_handed|itp_cant_reload_on_horseback ,itcf_shoot_crossbow|itcf_carry_crossbow_back,	683 , weight(3.75)|abundance(20)|difficulty(10)|spd_rtng(22) | shoot_speed(90) | thrust_damage(58 ,pierce)|max_ammo(1),imodbits_crossbow ],
#easter egg
...
["flintlock_pistol", 					"Flintlock Pistol", 				[("flintlock_pistol_1",0)],	itp_merchandise|itp_type_pistol|itp_primary ,itcf_shoot_pistol|itcf_reload_pistol,																2300, weight(1.5)|abundance(1)|spd_rtng(55) | shoot_speed(160) | thrust_damage(45 ,pierce)|max_ammo(1)|accuracy(75),imodbits_none, [(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,27),(position_move_y, pos1,36),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],
["flintlock_rifle", 					"Flintlock Rifle",					[("flintlock_rifle_1",0)],	itp_merchandise|itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed, itcf_reload_musket|itcf_carry_spear|itcf_shoot_musket,	2800, weight(1.5)|abundance(2)|difficulty(0)|spd_rtng(24) | shoot_speed(180) | thrust_damage(95 ,pierce)|max_ammo(1)|accuracy(99),imodbits_none, [(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,0),(position_move_y, pos1,139),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],
["arquebus", 							"Arquebus",							[("arquebus",0)],			itp_merchandise|itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed, itcf_reload_musket|itcf_carry_spear|itcf_shoot_musket,	3100, weight(1.5)|abundance(2)|difficulty(0)|spd_rtng(45) | shoot_speed(160) | thrust_damage(60 ,pierce)|max_ammo(1)|accuracy(78),imodbits_none, [(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,0),(position_move_y, pos1,100),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],
["blunderbus", 							"Blunderbus",						[("blunderbus",0)],			itp_merchandise|itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed, itcf_reload_musket|itcf_carry_spear|itcf_shoot_musket,	4600, weight(1.5)|abundance(2)|difficulty(0)|spd_rtng(50) | shoot_speed(160) | thrust_damage(85 ,pierce)|max_ammo(1)|accuracy(70),imodbits_none, [(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,0),(position_move_y, pos1,72),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],
["matchlock_musket_a", 					"Matchlock Musket",					[("matchlock_2",0)],		itp_merchandise|itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed, itcf_reload_musket|itcf_carry_spear|itcf_shoot_musket,	2800, weight(1.5)|abundance(2)|difficulty(0)|spd_rtng(38) | shoot_speed(160) | thrust_damage(70 ,pierce)|max_ammo(1)|accuracy(85),imodbits_none, [(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,0),(position_move_y, pos1,112),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],
["matchlock_musket_b", 					"Matchlock Musket",					[("matchlock_1",0)],		itp_merchandise|itp_type_musket|itp_cant_reload_on_horseback|itp_primary|itp_two_handed, itcf_reload_musket|itcf_carry_spear|itcf_shoot_musket,	3800, weight(1.5)|abundance(2)|difficulty(0)|spd_rtng(42) | shoot_speed(160) | thrust_damage(65 ,pierce)|max_ammo(1)|accuracy(80),imodbits_none, [(ti_on_weapon_attack, [(play_sound,"snd_pistol_shot"),(position_move_x, pos1,0),(position_move_y, pos1,107),(particle_system_burst, "psys_pistol_smoke", pos1, 15)])]],
...
["buckler_c", 					"Buckler", 						[("s_h2_2",0)],				itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,	250,	weight(3)|hit_points(275)|body_armor(13)|spd_rtng(100)|shield_width(60),imodbits_shield ],
["decorated_brass_shield_a", 	"Decorated Brass Shield", 		[("brass_shield1",0)],		itp_merchandise|itp_type_shield, itcf_carry_round_shield,					350,	weight(4)|hit_points(275)|body_armor(17)|spd_rtng(85)|shield_width(40),imodbits_shield ],
["decorated_brass_shield_b", 	"Decorated Brass Shield", 		[("brass_shield",0)],		itp_merchandise|itp_type_shield, itcf_carry_round_shield,					350,	weight(4)|hit_points(275)|body_armor(17)|spd_rtng(85)|shield_width(40),imodbits_shield ],
["painted_brass_shield_a", 		"Painted Brass Shield", 		[("brass_shield2",0)],		itp_merchandise|itp_type_shield, itcf_carry_round_shield,					350,	weight(4)|hit_points(275)|body_armor(17)|spd_rtng(85)|shield_width(40),imodbits_shield ],

["painted_brass_shield_b", 		"Painted Brass Shield", 		[("brass_shield3",0)],		itp_merchandise|itp_type_shield, itcf_carry_round_shield,					450,	weight(4)|hit_points(350)|body_armor(17)|spd_rtng(85)|shield_width(40),imodbits_shield ],
["painted_brass_shield_c", 		"Painted Brass Shield", 		[("brass_shield7",0)],		itp_merchandise|itp_type_shield, itcf_carry_round_shield,					450,	weight(4)|hit_points(350)|body_armor(17)|spd_rtng(85)|shield_width(40),imodbits_shield ],
["decorated_round_shield_a",	"Decorated Round Shield",		[("saracin_shield_y",0)],	itp_merchandise|itp_type_shield, itcf_carry_round_shield,					550,	weight(8)|hit_points(250)|body_armor(20)|spd_rtng(90)|shield_width(52), imodbits_shield ],
["decorated_round_shield_b",	"Decorated Round Shield",		[("saracin_shield_v",0)],	itp_merchandise|itp_type_shield, itcf_carry_round_shield,					550,	weight(8)|hit_points(250)|body_armor(20)|spd_rtng(90)|shield_width(52), imodbits_shield ],
["spiked_buckler_a", 			"Spiked Buckler", 				[("s_h1",0)],				itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,	600,	weight(4)|hit_points(350)|body_armor(16)|spd_rtng(100)|shield_width(60),imodbits_shield ],
["spiked_buckler_b", 			"Spiked Buckler", 				[("s_h1_1",0)],				itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,	600,	weight(4)|hit_points(350)|body_armor(16)|spd_rtng(100)|shield_width(60),imodbits_shield ],
["spiked_buckler_c", 			"Spiked Buckler", 				[("s_h1_2",0)],				itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,	600,	weight(4)|hit_points(350)|body_armor(16)|spd_rtng(100)|shield_width(60),imodbits_shield ],

["decorated_round_shield_c",	"Decorated Round Shield",		[("saracin_shield_w",0)],	itp_merchandise|itp_type_shield, itcf_carry_round_shield,					750,	weight(8)|hit_points(300)|body_armor(21)|spd_rtng(90)|shield_width(52), imodbits_shield ],
["decorated_round_shield_d",	"Decorated Round Shield",		[("shield_vostoka_a",0)],	itp_merchandise|itp_type_shield, itcf_carry_round_shield,					850,	weight(8)|hit_points(300)|body_armor(21)|spd_rtng(85)|shield_width(57), imodbits_shield ],
["decorated_shield_a",			"Decorated Shield",				[("saracin_shield_b",0)],	itp_merchandise|itp_type_shield, itcf_carry_round_shield,					1000,	weight(5)|hit_points(325)|body_armor(19)|spd_rtng(85)|shield_width(50), imodbits_shield ],
["decorated_shield_b",			"Decorated Shield",				[("saracin_shield_f",0)],	itp_merchandise|itp_type_shield, itcf_carry_round_shield,					1000,	weight(5)|hit_points(325)|body_armor(19)|spd_rtng(85)|shield_width(50), imodbits_shield ],
...
["leather_covered_heater_shield",	"Leather Covered Heater Shield",	[("shield_heater_c",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 250 , weight(3.5)|hit_points(340)|body_armor(10)|spd_rtng(80)|shield_width(50),imodbits_shield ],
["painted_heater_shield", 			"Painted Heater Shield",			[("shield_11" ,0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 750 , weight(2.5)|hit_points(400)|body_armor(23)|spd_rtng(100)|shield_width(30)|shield_height(50),imodbits_shield ],


########## Kite ##########

["kite_shield_a",		"Kite Shield",			[("norman_shield_1",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 125, weight(2.5)|hit_points(180)|body_armor(8)|spd_rtng(82)|shield_width(90),imodbits_shield ],
["kite_shield_b",		"Kite Shield",			[("norman_shield_2",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 125, weight(2.5)|hit_points(180)|body_armor(8)|spd_rtng(82)|shield_width(90),imodbits_shield ],

["kite_shield_c",		"Kite Shield",			[("norman_shield_3",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 275, weight(2.5)|hit_points(240)|body_armor(10)|spd_rtng(82)|shield_width(90),imodbits_shield ],
["kite_shield_d",		"Kite Shield",			[("norman_shield_4",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 275, weight(2.5)|hit_points(240)|body_armor(10)|spd_rtng(82)|shield_width(90),imodbits_shield ],

["kite_shield_e",		"Kite Shield",			[("norman_shield_5",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 375, weight(2.5)|hit_points(320)|body_armor(12)|spd_rtng(82)|shield_width(90),imodbits_shield ],
["kite_shield_f",		"Kite Shield",			[("norman_shield_6",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 375, weight(2.5)|hit_points(320)|body_armor(12)|spd_rtng(82)|shield_width(90),imodbits_shield ],

["kite_shield_g",		"Kite Shield",			[("norman_shield_7",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 450, weight(2.5)|hit_points(400)|body_armor(14)|spd_rtng(82)|shield_width(90),imodbits_shield ],
["kite_shield_h",		"Kite Shield",			[("norman_shield_8",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 450, weight(2.5)|hit_points(400)|body_armor(14)|spd_rtng(82)|shield_width(90),imodbits_shield ],

["steel_kite_shield", 	"Steel Kite Shield",	[("steel_kite1",0)],		itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield, 820, weight(5.5)|hit_points(450)|body_armor(17)|spd_rtng(55)|shield_width(40)|shield_height(70),imodbits_shield ],


########### Heraldic ##########

["old_round_shield", 				"Old Round Shield",			[("tableau_shield_round_5",0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,								26, weight(2.5)|hit_points(200)|body_armor(6)|spd_rtng(93)|shield_width(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_round_shield_5", ":agent_no", ":troop_no")])]],
["plain_round_shield", 				"Plain Round Shield",		[("tableau_shield_round_3",0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,								65, weight(3)|hit_points(260)|body_armor(8)|spd_rtng(90)|shield_width(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_round_shield_3", ":agent_no", ":troop_no")])]],
["round_shield", 					"Round Shield",				[("tableau_shield_round_2",0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,								105, weight(3.5)|hit_points(310)|body_armor(9)|spd_rtng(87)|shield_width(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner","tableau_round_shield_2", ":agent_no", ":troop_no")])]],
["heavy_round_shield", 				"Heavy Round Shield", 		[("tableau_shield_round_1",0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,								210, weight(4)|hit_points(400)|body_armor(12)|spd_rtng(84)|shield_width(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_round_shield_1", ":agent_no", ":troop_no")])]],
["huscarls_round_shield", 			"Huscarl's Round Shield",	[("tableau_shield_round_4",0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,								430, weight(4.5)|hit_points(475)|body_armor(15)|spd_rtng(81)|shield_width(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_round_shield_4", ":agent_no", ":troop_no")])]],

["old_heater_shield", 				"Old Heater Shield",		[("tableau_shield_heater_1" ,0)],		itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								36, weight(2)|hit_points(160)|body_armor(6)|spd_rtng(96)|shield_width(36)|shield_height(70),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_heater_shield_1", ":agent_no", ":troop_no")])]],
["plain_heater_shield", 			"Plain Heater Shield",		[("tableau_shield_heater_1" ,0)],		itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								74, weight(2.5)|hit_points(210)|body_armor(11)|spd_rtng(93)|shield_width(36)|shield_height(70),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_heater_shield_1", ":agent_no", ":troop_no")])]],
["heater_shield", 					"Heater Shield",			[("tableau_shield_heater_1" ,0)],		itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								160, weight(3)|hit_points(260)|body_armor(14)|spd_rtng(90)|shield_width(36)|shield_height(70),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_heater_shield_1", ":agent_no", ":troop_no")])]],
["heavy_heater_shield", 			"Heavy Heater Shield",		[("tableau_shield_heater_1" ,0)],		itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								332, weight(3.5)|hit_points(305)|body_armor(19)|spd_rtng(87)|shield_width(36)|shield_height(70),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_heater_shield_1", ":agent_no", ":troop_no")])]],

["horsemans_heater_shield", 		"Horseman's Heater Shield",	[("tableau_shield_heater_2" ,0)],		itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								229, weight(2)|hit_points(375)|body_armor(16)|spd_rtng(103)|shield_width(30)|shield_height(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_heater_shield_2", ":agent_no", ":troop_no")])]],
["knightly_heater_shield", 			"Knightly Heater Shield",	[("tableau_shield_heater_2" ,0)],		itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								390, weight(2.5)|hit_points(425)|body_armor(23)|spd_rtng(100)|shield_width(30)|shield_height(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_heater_shield_2", ":agent_no", ":troop_no")])]],

["old_kite_shield", 				"Old Kite Shield",			[("tableau_shield_kite_1" ,0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								33, weight(2)|hit_points(165)|body_armor(5)|spd_rtng(96)|shield_width(36)|shield_height(70),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_kite_shield_1", ":agent_no", ":troop_no")])]],
["plain_kite_shield", 				"Plain Kite Shield",		[("tableau_shield_kite_3" ,0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								70, weight(2.5)|hit_points(215)|body_armor(10)|spd_rtng(93)|shield_width(36)|shield_height(70),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_kite_shield_3", ":agent_no", ":troop_no")])]],
...
["heavy_kite_shield", 				"Heavy Kite Shield",		[("tableau_shield_kite_2" ,0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								320, weight(3.5)|hit_points(310)|body_armor(18)|spd_rtng(87)|shield_width(36)|shield_height(70),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_kite_shield_2", ":agent_no", ":troop_no")])]],

["horsemans_kite_shield", 			"Horseman's Kite Shield",	[("tableau_shield_kite_4" ,0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								205, weight(2)|hit_points(375)|body_armor(14)|spd_rtng(103)|shield_width(30)|shield_height(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_kite_shield_4", ":agent_no", ":troop_no")])]],
["knightly_kite_shield", 			"Knightly Kite Shield",		[("tableau_shield_kite_4" ,0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,								360, weight(2.5)|hit_points(425)|body_armor(23)|spd_rtng(100)|shield_width(30)|shield_height(50),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_kite_shield_4", ":agent_no", ":troop_no")])]],

["old_board_shield", 				"Old Board Shield",			[("tableau_shield_pavise_2" ,0)],		itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_board_shield,	60, weight(3.5)|hit_points(280)|body_armor(4)|spd_rtng(89)|shield_width(43)|shield_height(100),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_pavise_shield_2", ":agent_no", ":troop_no")])], [fac_kingdom_5]],
["plain_board_shield", 				"Plain Board Shield",		[("tableau_shield_pavise_2" ,0)],		itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_board_shield,	114, weight(4)|hit_points(360)|body_armor(8)|spd_rtng(85)|shield_width(43)|shield_height(100),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_pavise_shield_2", ":agent_no", ":troop_no")])], [fac_kingdom_5]],
["board_shield", 					"Board Shield",				[("tableau_shield_pavise_1" ,0)],		itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_board_shield,	210, weight(4.5)|hit_points(430)|body_armor(10)|spd_rtng(81)|shield_width(43)|shield_height(100),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_pavise_shield_1", ":agent_no", ":troop_no")])], [fac_kingdom_5]],
["heavy_board_shield", 				"Heavy Board Shield",		[("tableau_shield_pavise_1" ,0)],		itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_board_shield,	370, weight(5)|hit_points(550)|body_armor(14)|spd_rtng(78)|shield_width(43)|shield_height(100),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_pavise_shield_1", ":agent_no", ":troop_no")])], [fac_kingdom_5]],

["plain_cavalry_shield", 			"Plain Cavalry Shield",		[("tableau_shield_small_round_3",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,								96, weight(2)|hit_points(160)|body_armor(8)|spd_rtng(105)|shield_width(40),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_small_round_shield_3", ":agent_no", ":troop_no")])]],
["round_cavalry_shield", 			"Round Cavalry Shield",		[("tableau_shield_small_round_1",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,								195, weight(2.5)|hit_points(310)|body_armor(12)|spd_rtng(103)|shield_width(40),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_small_round_shield_1", ":agent_no", ":troop_no")])]],
["elite_cavalry_shield", 			"Elite Cavalry Shield",		[("tableau_shield_small_round_2",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,								370, weight(3)|hit_points(425)|body_armor(15)|spd_rtng(100)|shield_width(40),imodbits_shield, [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_small_round_shield_2", ":agent_no", ":troop_no")])]],


########### Mercenary ##########

["blue_company_round_shield",		"Blue Company Round Shield",	[("shields_archer_antioh_a",0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 350, weight(4)|hit_points(300)|body_armor(15)|spd_rtng(61)|shield_width(40), imodbits_shield ],
["blue_company_heater_shield_a",	"Blue Company Heater Shield",	[("shield_knight_antioh_d",0)],				itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 750, weight(6)|hit_points(350)|body_armor(18)|spd_rtng(57)|shield_width(40), imodbits_shield ],
["blue_company_heatet_shield_b",	"Blue Company Heater Shield",	[("antioh_shield_a",0)],					itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 750, weight(5)|hit_points(350)|body_armor(20)|spd_rtng(59)|shield_width(40), imodbits_shield ],
["blue_company_kite_shield_a",		"Blue Company Kite Shield",		[("shield_veteran_antioh_b",0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 1250, weight(5)|hit_points(450)|body_armor(22)|spd_rtng(52)|shield_width(40), imodbits_shield ],
["blue_company_kite_shield_b",		"Blue Company Kite Shield",		[("shield_veteran_antioh_g",0)],			itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 1250, weight(5)|hit_points(450)|body_armor(22)|spd_rtng(52)|shield_width(40), imodbits_shield ],
["caravan_guard_shield",			"Caravan Guard Shield",			[("securiti_caravan_crusader_shield",0)],	itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 800, weight(2.5)|hit_points(400)|body_armor(24)|spd_rtng(96)|shield_width(40), imodbits_shield ],


########### Bandit ##########

["bandit_shield_a",		"Bandit Shield",			[("bandit_shield_a",0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 150, weight(2.5)|hit_points(200)|body_armor(15)|spd_rtng(96)|shield_width(40), imodbits_shield ],
["bandit_shield_b",		"Bandit Shield",			[("bandit_shield_b",0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 150, weight(2.5)|hit_points(200)|body_armor(15)|spd_rtng(96)|shield_width(40), imodbits_shield ],

["bandit_shield_c",		"Bandit Shield",			[("bandit_shield_d",0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 250, weight(2.5)|hit_points(300)|body_armor(15)|spd_rtng(96)|shield_width(40), imodbits_shield ],
["bandit_shield_d",		"Bandit Shield",			[("bandit_shield_c",0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 250, weight(2.5)|hit_points(300)|body_armor(18)|spd_rtng(96)|shield_width(40), imodbits_shield ],

["bandit_shield_e",		"Bandit Shield",			[("bandit_shield_e",0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 350, weight(2.5)|hit_points(400)|body_armor(18)|spd_rtng(96)|shield_width(40), imodbits_shield ],
["bandit_shield_f",		"Bandit Shield",			[("bandit_shield_f",0)], itp_merchandise|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield, 350, weight(2.5)|hit_points(400)|body_armor(18)|spd_rtng(96)|shield_width(40), imodbits_shield ],
