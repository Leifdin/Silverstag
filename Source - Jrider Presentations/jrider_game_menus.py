...
def modmerge(var_set):
	try:
		...
		# Inside menu "reports" -> menu option "view_faction_relations_report" should be replaced with codeblock [ faction_relations_menu ].
		...
		# submenu_index = list_find_first_containing_i(menuoptions, "view_faction_relations_report")
		# submenu = GameMenuOptionWrapper(menuoptions[submenu_index])
		# codeblock = submenu.GetConsequenceBlock()
		# codeblock.append = faction_relations_menu
	except KeyError:
