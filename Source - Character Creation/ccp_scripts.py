...
("ccp_initialize_faction_items",
	[
		...
		(troop_set_slot, ccp_data, ccp_swadia_item_shield, "itm_old_heater_shield"),
		...
		(troop_set_slot, ccp_data, ccp_swadia_item_spear, "itm_short_spear"),             # Diff 0
		...
		(troop_set_slot, ccp_data, ccp_vaegir_item_shield, "itm_old_heater_shield"),
		...
		(troop_set_slot, ccp_data, ccp_vaegir_item_spear, "itm_short_spear"),             # Diff 0
		...
		(troop_set_slot, ccp_data, ccp_khergit_item_shield, "itm_old_heater_shield"),
		...
		(troop_set_slot, ccp_data, ccp_khergit_item_spear, "itm_short_spear"),             # Diff 0
		...
		(troop_set_slot, ccp_data, ccp_nord_item_shield, "itm_old_heater_shield"),
		...
		(troop_set_slot, ccp_data, ccp_nord_item_spear, "itm_short_spear"),             # Diff 0
		...
		(troop_set_slot, ccp_data, ccp_rhodok_item_shield, "itm_old_heater_shield"),
		...
		(troop_set_slot, ccp_data, ccp_rhodok_item_spear, "itm_short_spear"),             # Diff 0
		...
		(troop_set_slot, ccp_data, ccp_sarrand_item_shield, "itm_old_heater_shield"),
		...
		(troop_set_slot, ccp_data, ccp_sarrand_item_spear, "itm_short_spear"),             # Diff 0
...
("ccp_get_character_background_text",
	[
		...
		(else_try),
			(eq, "$background_type", cb_dev),
			(str_store_string, s2, "@a Silverstag Dev"),
			(str_store_string, s3, "@He created new troops and would like you to play test them."),
...
("ccp_generate_skill_set",
	[
		...
		(else_try),
			...
			(assign, ":blunt", 1),
		(else_try),
			(eq,"$background_type", cb_dev), # For testers
			(val_add, ":strength", 8),
			(val_add, ":charisma", 8),
			(val_add, ":intelligence", 8),
			(val_add, ":agility", 8),
			(val_add, ":skill_woundtreatment", 3),
			(val_add, ":skill_persuasion", 3),
			(val_add, ":skill_leadership", 3),
			(val_add, ":skill_firstaid", 3),
			(val_add, ":skill_ironflesh", 3),
			(val_add, ":skill_powerstrike", 3),
			(val_add, ":skill_powerthrow", 3),
			(val_add, ":skill_powerdraw", 3),
			(val_add, ":skill_tactics", 3),
			(val_add, ":skill_pathfinding", 3),
			(val_add, ":skill_weaponmaster", 3),
			(val_add, ":prof_polearm", 120),
			(val_add, ":prof_onehand", 120),
			(val_add, ":prof_throwing", 120),
			(val_add, ":prof_crossbow", 120),
			(val_add, ":prof_archery", 120),
			(val_add, ":prof_twohand", 120),
			(val_add, ":gold", 15000),
			(assign, ":richhorse", 1),
			(assign, ":blunt", 1),
...
("ccp_tester_settings",
	[
		...
		(troop_set_skill, "trp_player", skl_surgery, 0),
