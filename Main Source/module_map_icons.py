...
map_icons = [
  ...
  ## WINDYPLAINS+ ## - Map Icons Pack by Slawomir of Aaarrghh
  ("battlefield_a",0,"dedal_battlefield_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("battlefield_b",0,"dedal_battlefield_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("battlefield_c",0,"dedal_battlefield_c", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("battlefield_d",0,"dedal_battlefield_d", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  # Swadia
  ("swadia_king_a",0,"dedal_map_swadia_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("swadia_king_b",0,"dedal_map_swadia_king_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("swadia_king_c",0,"dedal_map_swadia_king_c", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("swadia_lord_a",0,"dedal_map_swadia_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("swadia_lord_b",0,"dedal_map_swadia_lord_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("swadia_lord_c",0,"dedal_map_swadia_lord_c", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("swadia_band_a",0,"dedal_map_swadia_band_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("swadia_band_b",0,"dedal_map_swadia_band_b", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("swadia_band_c",0,"dedal_map_swadia_band_c", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  # Nords
  ("nordic_king_a",0,"dedal_map_nordic_king_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("nordic_king_b",0,"dedal_map_nordic_king_b", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("nordic_king_c",0,"dedal_map_nordic_king_c", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("nordic_lord_a",0,"dedal_map_nordic_lord_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("nordic_lord_b",0,"dedal_map_nordic_lord_b", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("nordic_lord_c",0,"dedal_map_nordic_lord_c", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("nordic_band_a",0,"dedal_map_nordic_band_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("nordic_band_b",0,"dedal_map_nordic_band_b", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  # Khergits
  ("khergit_king_a",0,"dedal_map_khergit_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("khergit_king_b",0,"dedal_map_khergit_king_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("khergit_king_c",0,"dedal_map_khergit_king_c", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("khergit_lord_a",0,"dedal_map_khergit_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("khergit_lord_b",0,"dedal_map_khergit_lord_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("khergit_lord_c",0,"dedal_map_khergit_lord_c", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("khergit_band_a",0,"dedal_map_khergit_band_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("khergit_band_b",0,"dedal_map_khergit_band_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  # Vaegirs
  ("vaegir_king_a",0,"dedal_map_vaegir_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("vaegir_king_b",0,"dedal_map_vaegir_king_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("vaegir_king_c",0,"dedal_map_vaegir_king_c", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("vaegir_lord_a",0,"dedal_map_vaegir_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("vaegir_lord_b",0,"dedal_map_vaegir_lord_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("vaegir_lord_c",0,"dedal_map_vaegir_lord_c", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("vaegir_band_a",0,"dedal_map_vaegir_band_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("vaegir_band_b",0,"dedal_map_vaegir_band_b", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  # Rhodoks
  ("rhodok_king_a",0,"dedal_map_rhodok_king_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_king_b",0,"dedal_map_rhodok_king_b", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_king_c",0,"dedal_map_rhodok_king_c", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_lord_a",0,"dedal_map_rhodok_lord_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_lord_b",0,"dedal_map_rhodok_lord_b", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_lord_c",0,"dedal_map_rhodok_lord_c", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_band_a",0,"dedal_map_rhodok_band_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_band_b",0,"dedal_map_rhodok_band_e", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  # Bandits
  ("bandit_mountain_bandit",0,"dedal_map_mountain_bandit", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("bandit_forest_bandit",0,"dedal_map_forest_bandit", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("bandit_sea_raider",0,"dedal_map_sea_raider", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  # NPCs
  ("npc_manhunter",0,"dedal_map_manhunter", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("npc_ranger",0,"dedal_map_ranger", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ## WINDYPLAINS- ##
]
