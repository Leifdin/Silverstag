...
# KMT 1.0
####################################################################################################################################
  # ("kmt_backdrop_lord_holdings", 0, "mp_ui_profile", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  # ("kmt_label_panel", 0, "longer_button", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  # ("kmt_label_panel_selected", 0, "longer_button_down", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_map_calradia_half", 0, "pic_map_calradia_half", 0, 0, 0, 0, 0, 0, 1.0, 0.76, 0.5),
