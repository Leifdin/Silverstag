# Tournament Play Enhancements (1.61) by Windyplains

from header_item_modifiers import *

# WHAT THIS FILE DOES:
# Defines new "slot_troop" constants.   # 350-374
# Defines new "slot_center" constants.  # 233-235
...
slot_troop_tournament_scaled_level     = 365 
...
slot_troop_tournament_flag_to_continue = 370 # TPE+ 1.6  # This sets up who should continue on in elimination mode.
...
#####                                               RENOWN SCALING                                                    #####
###########################################################################################################################
wp_tpe_max_renown                      = 30   # This sets a hard limit on how much renown can be gained at most.  
...
wp_tpe_bet_maximum                     = 150   # Change this value to set your mod's upper limit for betting per round.
...
###########################################################################################################################
wp_tpe_released_version                = 160  # This is to prevent features not yet ready for release from functioning.  No peeking :P
wp_tpe_max_tournament_participants     = 32
wp_tpe_max_tournament_tiers            = 3 # 6
...
tpe2_obj_button_exit                       = 10
tpe2_obj_main_title                        = 11
tpe2_obj_container_items                   = 12
tpe2_obj_title_commissions                 = 13
tpe2_obj_container_selected_item           = 14
tpe2_val_selected_item_no                  = 15
tpe2_obj_image_selected_item               = 16
tpe2_obj_label_selected_item               = 17
tpe2_val_selected_imod                     = 18
tpe2_val_selected_price                    = 19
tpe2_val_selected_item_no                  = 20
tpe2_obj_label_selected_imod               = 21
tpe2_val_minimum_price_limit               = 22 # This needs to be set prior to presentation start.
tpe2_val_maximum_price_limit               = 23 # This needs to be set prior to presentation start.
tpe2_val_total_records                     = 24 # This is populated from script_tpe_generate_prize_list
tpe2_obj_label_selected_price              = 25
tpe2_obj_label_reward_group                = 26
tpe2_obj_button_take_selected              = 27
tpe2_obj_button_take_valuable              = 28
tpe2_obj_label_valuable_item               = 29
tpe2_obj_label_valuable_imod               = 30
tpe2_obj_label_valuable_price              = 31
tpe2_obj_image_valuable_item               = 32

# Display Groups ("$tpe_award_group")
REWARD_GROUP_ONE_HANDED              = 0
REWARD_GROUP_TWO_HANDED              = 1
REWARD_GROUP_POLEARMS                = 2
REWARD_GROUP_RANGED_WEAPONS          = 3
REWARD_GROUP_AMMUNITION              = 4
REWARD_GROUP_SHIELDS                 = 5
REWARD_GROUP_HELMETS                 = 6
REWARD_GROUP_BODY                    = 7
REWARD_GROUP_BOOTS                   = 8
REWARD_GROUP_HANDS                   = 9
REWARD_GROUP_MOUNTS                  = 10
REWARD_GROUP_BOOKS                   = 11 # Books have been intentionally removed as they're too expensive for low level tournaments.

REWARD_GROUPS_BEGIN                  = REWARD_GROUP_ONE_HANDED
REWARD_GROUPS_END                    = REWARD_GROUP_BOOKS

## MODULE PREFERENCE SETTINGS
TPE_FIRST_ITEM                       = "itm_sumpter_horse" # This is the first item in module_items you want people to be able to commission.
TPE_LAST_ITEM                        = "itm_items_end"     # This is the last valid item in module_items you want people to be able to commission.
TPE_SETTING_USE_REGIONAL_FLAGS       = 1    # (0 - No / 1 - Yes) Only display items flagged for this region in the center you're commissioning an item from.
TPE_SETTING_LIMIT_TO_MERCHANDISE     = 1    # (0 - No / 1 - Yes) If enabled, only items flagged itp_merchandise will be commissionable.
TPE_SETTING_ALLOW_FIREARMS           = 0    # (0 - No / 1 - Yes) If enabled, firearms and ammunition will appear as tournament awards.
TPE_ARRAY_RECORD_LIMIT               = 500
TPE_IMODS_BEGIN                      = imod_plain          # This should be your #0 imod.
TPE_IMODS_END                        = imod_large_bag+1      # This should be the last imod of the module.
TPE_IMOD_AVAILABILITY_CHANCE         = 75   # This is the % chance an imod for this item can be here at all.
TPE_AWARD_ARRAY_SLOT_NO              = "trp_silverstag_array_a"
TPE_AWARD_ARRAY_ITEM_NO              = "trp_silverstag_array_b"
TPE_AWARD_ARRAY_OBJECT_NO            = "trp_silverstag_array_c"
TPE_AWARD_ARRAY_IMOD                 = "trp_silverstag_array_d"
##### TOURNAMENT REWARDS PANEL- #####
...
TPE_LOG_KNOCKOUTS                          = "trp_tpe_log_knockouts"
TPE_OBJECTS                                = "trp_tpe_presobj"
...
# OBJECT DEFINITIONS:
# records_log_type                           = 100
records_obj_data_container                 = 2
records_obj_city_container                 = 3
records_obj_toggle_log_mode                = 4

###########################################################################################################################
#####                                                ELIMINATION MODE                                                 #####
###########################################################################################################################
tpe_mode_performance                       = 0
tpe_mode_elimination                       = 1

# Methods used for filling in the roster for a round via script "tpe_designate_continuing_participants".
FTC_RESET                                  = 0
FTC_TEAM                                   = 1
FTC_FILL_REMAINING                         = 2
