...
# Reinforcements
 ...
 #("kingdom_6_reinforcements_l", "kingdom_6_reinforcements_l", 0, 0, fac_commoners, 0, [(trp_sarranid_guard,2,3),(trp_sarranid_master_archer,2,3),(trp_sarranid_mamluke,2,10)]),
  ...
  ("troop_testing_party_1", "Troop Testing Party", icon_axeman|pf_is_static, 0, fac_deserters, troop_testers, [(trp_item_balancing_pike, 50, 50)]),
  ("troop_testing_party_2", "Troop Testing Party", icon_axeman|pf_is_static, 0, fac_deserters, troop_testers, [(trp_item_balancing_poleaxe, 50, 50)]),
]
