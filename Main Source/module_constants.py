...
slot_faction_troops_begin               = 198 # Tracks the first troop in a faction's list of troops.
slot_faction_troops_end                 = 199 # Tracks the last troop in a faction's list of troops.
...
## WINDYPLAINS+ ## - Mercenary storage slots moved to another location now that npc_volunteers cover all centers.
...
## WINDYPLAINS+ ## - Mercenary storage slots moved to another location now that npc_volunteers cover all centers.
# slot_center_mercenary_troop_type  = 101
# slot_center_mercenary_troop_amount= 102
slot_center_mercenary_pool_player = 101
slot_center_mercenary_pool_npc    = 102
slot_center_horse_pool_player     = 103
slot_center_horse_pool_npc        = 104
slot_center_horse_pool_imported   = 105
## WINDYPLAINS- ##
## WINDYPLAINS+ ##
slot_center_original_culture      = 106  # Stores the original culture (faction id) of a center so the AI can revert it back.
slot_center_original_name         = 107  # Stores the original name of a center so the AI can revert it back.
## WINDYPLAINS- ##
...
slot_center_current_improvement   = 124 # Moved to 390.  This one kept for save game compatibility.
slot_center_improvement_end_hour  = 125 # Moved to 393.  This one kept for save game compatibility.
...
slot_production_sources_begin   = 209  ## 1.151 ##
...
slot_production_sources_end = 233    ## 1.151 ##
...
## WINDYPLAINS+ ## - qst_hunt_down_fugitive - Provide a slot to storage a hidden companion's ID on the fugitive troop.
slot_fugitive_home_town                     = slot_troop_betrothal_time
slot_fugitive_companion_id                  = slot_lady_used_tournament
## WINDYPLAINS- ##
...
tmt_honest = 4
tmt_pious = 5
## WINDYPLAINS+ ## - Added new objecitonal actions for companions.
tmt_gladiator = 6      # This will cause companions to praise tournament participation. (Nissa)
tmt_egotistic = 7      # This will cause companions to complain about not attending tournaments. (Nissa)
## WINDYPLAINS- ##
...
## WINDYPLAINS+ ## - New NPC Mission Types
npc_mission_remaining_in_quest_location = 9
## WINDYPLAINS- ##
...
## WINDYPLAINS+ ## - Troop Slots
slot_troop_name_changed                = 158   # Used for the renaming scripts.  Tracks if a troop was already altered to prevent upgrade silliness.
## WINDYPLAINS- ##
slot_troop_will_join_prison_break      = 161
## WINDYPLAINS+ ## - Custom Commander - Battle debrief stats.
slot_troop_kill_count                  = 162
slot_troop_wound_count                 = 163
## WINDYPLAINS- ##
## WINDYPLAINS+ ## - Caba'drin's Trade Ledger
## Floris - Trade ledger
spt_array = -1
slot_troop_trade_ledger = 164
...
## WINDYPLAINS+ ## - Added room for killing off nobles via events.
slto_deceased           = 10 # Not really an occupation, but inactive isn't the same.
## WINDYPLAINS- ##
...
## WINDYPLAINS+ ## - Native Bugfix (Ticket #860, v0.23) - Prevent aborting quests when unnecessary.
minister_quests_begin = "qst_consult_with_minister"
minister_quests_end   = "qst_track_down_bandits"
## WINDYPLAINS- ##
...
## WINDYPLAINS+ ## - Book references adjusted to allow for placeholders for future save game preservation.
reference_books_begin = "itm_book_wound_treatment_reference"
reference_books_end   = "itm_book_1_reference" # trade_goods_begin
readable_books_begin = "itm_book_tactics"
readable_books_end   = "itm_book_1" # reference_books_begin
## WINDYPLAINS- ##
...
DEBUG_TREASURY                = 0
DEBUG_RECRUITMENT             = 0
DEBUG_PARTY_MORALE            = 0
# Graphical Presentation Utilities
wp_gpu_debug                  = 0   # This turns ON (1) or OFF (0) all of the debug messages.  Set to 2 will enable -very- verbose information.
# Health Regeneration
DEBUG_COMBAT                  = 0   # This turns ON (1) or OFF (0) all of the debug messages.
# Kingdom Management Tools
...
DEBUG_TPE_LOOT                = 0   # ON (1) / OFF (0) - Displays any debug messages associated with the Tournament Prize System.
#### DEBUGGING SYSTEM ####
DEBUG_HUB                     = 0
BETA_TESTING_MODE             = 0   # ON (1) / OFF (0) - Give testers easier ways to get into things.
# DEBUG_SILVERSTAG_RECRUITMENT  = 0
DEBUG_TROOP_ABILITIES         = 0
DEBUG_TROOP_PREREQUISITES     = 0
DEBUG_GARRISON                = 0   # ON (1) / OFF (0) - Displays any debug messages associated with the Garrison Recruiting & Training System.
DEBUG_CCI                     = 0   # ON (1) / OFF (0) - Displays any debug messages associated with the Custom Commissioned Items System.
DEBUG_STAMINA                 = 0   # ON (1) / OFF (0) - Displays any debug messages associated with the Stamina bar.
DEBUG_SPRINTING               = 0   # ON (1) / OFF (0) - Displays any debug messages associated with Sprinting or its AI Logic.

# Game Modes
GAME_MODE_EASY = -1
GAME_MODE_NORMAL = 0
GAME_MODE_HARD = 1
GAME_MODE_VERY_HARD = 2

# Troop Naming Conventions
NAME_STYLE_IMMERSIVE          = 0  # Rhodok Crossbowman, Veteran Rhodok Crossbowman, Elite Rhodok Crossbowman
NAME_STYLE_FUNCTIONAL         = 1  # Rhodok Crossbowman, Rhodok Crossbowman (+), Rhodok Crossbowman (++)
NAME_STYLE_DESCRIPTIVE        = 2  # Rhodok Crossbowman, Rhodok Crossbowman (Veteran), Rhodok Crossbowman (Elite)
# NAME_STYLE_PREFIXES           = 3  # T3 Rhodok Crossbowman, T4 Rhodok Crossbowman, T5 Rhodok Crossbowman
# NAME_STYLE_PREFIX_IMMERSIVE   = 4  # T3 Rhodok Crossbowman, T4 Veteran Rhodok Crossbowman, T5 Elite Rhodok Crossbowman
# NAME_STYLE_PREFIX_FUNCTIONAL  = 5  # T3 Rhodok Crossbowman, T4 Rhodok Crossbowman (+), T5 Rhodok Crossbowman (++)
# NAME_STYLE_PREFIX_DESCRIPTIVE = 6  # T3 Rhodok Crossbowman, T4 Rhodok Crossbowman (Veteran), T5 Rhodok Crossbowman (Elite)
NS_REMOVE                     = 0
NS_ADD                        = 1

# Party AI Sizes (Note that normal is not needed)
party_size_ai_easy = -25
party_size_ai_hard = 20
party_size_ai_very_hard = 40

salt_mine_npc = "trp_salt_mine_merchant"

# Bandits series 2 was added so that bandits will join nearby combat.
bandits_2_begin = "trp_taiga_spearman"
bandits_2_end   = "trp_waywalker_pathwarden"
bandit_upgrades_begin = "trp_mountain_bandit_1"
...
vaegir_troops_end     = "trp_vaegir_end_troop"   # "trp_vaegir_troops_end"
khergit_troops_begin  = "trp_n_khergit_recruit"
khergit_troops_end    = "trp_khergit_end_troop"  # "trp_khergit_troops_end"
nord_troops_begin     = "trp_r_nord_hunter"
nord_troops_end       = "trp_nord_uniques_end"     # "trp_nord_troops_end"
...
unique_troops_end                      = "trp_player_unique_1"
kingdom_troops_begin                   = swadia_troops_begin
kingdom_troops_end                     = "trp_looter"  # sarranid_troops_end
troop_definitions_begin                = "trp_farmer"  # This spans the entire list of troop files for seeking unique types.
troop_definitions_end                  = "trp_module_end_troops"

### METRICS DATA
METRICS_DATA                           = "trp_array_metrics_data"
metrics_trainer_total_savings          = 100
metrics_trainer_troop_purchases        = 101
metrics_trainer_troop_saving           = 102
metrics_trainer_saving_per_rank        = 103
metrics_emblems_total_earned           = 104
metrics_emblems_total_spent            = 105
metrics_commissions_money_spent        = 106
metrics_commissions_total_requests     = 107
metrics_repairs_total_profit           = 108
metrics_repairs_total_repairs          = 109
metrics_repairs_total_upgrades         = 110
metrics_attributes_upgraded            = 111
metrics_skills_upgraded                = 112
metrics_original_save_major_version    = 113
metrics_original_save_minor_version    = 114
metrics_original_save_patch_version    = 115

### METRICS DISPLAY INFO
METRICS_OBJECTS                        = "trp_tpe_presobj"
met_obj_button_done                    = 100

## UNIQUE NPCS
NPC_IRON_MINE_MERCHANT                 = "trp_iron_mine_merchant"
