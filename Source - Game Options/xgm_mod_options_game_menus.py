...
camp_addon = [
	...
	("camp_mod_opition",[],"Change Game Settings.", 
		[
...
def modmerge_game_menus(orig_game_menus, check_duplicates = False):
	...
	OpBlockWrapper(menuoptions).InsertBefore(find_i, camp_addon)		

    # find_index = find_object(orig_game_menus, "camp")
    # orig_game_menus[find_index][5].insert(0,
            # ("camp_mod_opition",[],"Change Game Settings.", [(start_presentation, "prsnt_mod_option")]),
          # )
