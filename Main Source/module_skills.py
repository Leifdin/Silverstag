...
# Trade (1)
# Leadership (2) ## WINDYPLAINS+ ## - +8 party limit per point.
...
# Riding (25)
# Athletics (26)
# Shield (27) ## WINDYPLAINS+ ## - Uses Agility now.
# Weapon Master (28)
# Power Draw (34) ## WINDYPLAINS+ ## - Uses Agility now.
# Power Throw (35)
# Power Strike (36)
# Ironflesh (37)
#
...
skills = [
  ...
  ("leadership","Leadership",sf_base_att_cha,10,"Every point increases maximum number of troops you can command by 8, increases your party morale and reduces troop wages by 5%%. (Leader skill)"),
  ...
  ## WINDYPLAINS+ ## - Trainer skill functionality changed.
  ...
  ("training","Trainer",sf_base_att_int|sf_inactive,10,"Reduces the hiring cost of new soldiers by 2%% per skill level. (Leader skill)"), 
  ## WINDYPLAINS- ##
  ...
  ("shield","Shield",sf_base_att_str,10,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill)"),
