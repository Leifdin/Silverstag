...
########## Spears ##########
##### Tier 1 #####
["pitch_fork",		"Pitch Fork",		[("pitch_fork",0)],			itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 19, weight(1.55)|difficulty(0)|spd_rtng(109)|weapon_length(154)|swing_damage(16, blunt)|thrust_damage(22, pierce), imodbits_polearm ],
["scythe",			"Scythe",			[("scythe",0)],				itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 35, weight(2.55)|difficulty(0)|spd_rtng(110)|weapon_length(182)|swing_damage(22, cut) |thrust_damage(16, pierce), imodbits_polearm ],
##### Tier 2 #####
["peasant_spear",	"Peasant Spear",	[("crusader_spear_b",0)],	itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 45, weight(2.25)|difficulty(1)|spd_rtng(108)|weapon_length(190)|swing_damage(24,cut)|thrust_damage(27,pierce), imodbits_polearm ],
["boar_spear",		"Boar Spear",		[("spear",0)],				itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 55, weight(1.55)|difficulty(3)|spd_rtng(110)|weapon_length(157)|swing_damage(29, cut)|thrust_damage(23, pierce), imodbits_polearm ],
["short_spear",		"Short Spear",		[("spear_g_1-9m",0)],		itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 53, weight(1.25)|difficulty(2)|spd_rtng(122)|weapon_length(120)|swing_damage(19, blunt)|thrust_damage(28, pierce), imodbits_polearm ],
##### Tier 3 #####
["cutting_spear",	"Cutting Spear",	[("crusader_spear_a",0)],	itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 102, weight(2.2)|difficulty(5)|spd_rtng(105)|weapon_length(190)|swing_damage(36, cut)|thrust_damage(27, pierce), imodbits_polearm ],
["winged_spear",	"Winged Spear",		[("mameluk_spears_b",0)],	itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 175, weight(2.2)|difficulty(7)|spd_rtng(109)|weapon_length(190)|swing_damage(24, cut)|thrust_damage(31, pierce), imodbits_polearm ],
##### Tier 4 #####
["infantry_spear",	"Infantry Spear",	[("crusader_spear_c",0)],	itp_merchandise|itp_type_polearm|itp_offset_lance|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear, 225, weight(2.2)|difficulty(9)|spd_rtng(107)|weapon_length(190)|swing_damage(22, blunt)|thrust_damage(37, pierce), imodbits_polearm ],
...
["heavy_pike", "Heavy Pike", [("bb_rus_pike",0)], itp_type_polearm|itp_cant_use_on_horseback|itp_offset_lance|itp_merchandise|itp_primary|itp_two_handed|itp_wooden_parry|itp_cant_use_on_horseback, itc_staff,  582 , weight(4.5)|difficulty(7)|spd_rtng(105) | weapon_length(250)|swing_damage(21, cut) | thrust_damage(22 ,  pierce),imodbits_polearm, [], [fac_kingdom_2]],
