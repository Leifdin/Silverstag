...
##  ("your_debt_to_s1_is_changed_from_reg1_to_reg2", "Your debt to {s1} is changed from {reg1} to {reg2}."),
  ...
  ## WINDYPLAINS+ ## - Fixed grammar issues.
  ("village_alt_prosperity_60",   "The fields and orchards are humming with activity, with filled sacks of grain and drying meat testifying to the productivity of the village's crops and pastures."),
  ("village_alt_prosperity_80",   "The fields and orchards are humming with activity. Freshly dug irrigation ditches suggest that the farmers have had enough spare time and energy to expand the area under cultivation. Seasonal laborers appear to be flocking here to help with the work and join in the general prosperity."),
  ## WINDYPLAINS- ##
...
## WINDYPLAINS+ ## - New companion objections.
# egotistical
  ("leave_tournament", "tournament here to particpate in"),
 
# gladiator
  ("participate_tournament", "What a match!"),
## WINDYPLAINS- ##
...
#npc17 = nissa
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (intro)
  ("npc17_intro", "{Hey, pretty boy, have a glass of horse milk on me./What's a fine looking young woman like yourself doing without male admirers around here? Have a glass of horse milk on me.}"),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (intro response 1)
  ("npc17_intro_response_1", "Well, thank you. What's the occasion?"),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (intro response 2)
  ("npc17_intro_response_2", "Horse milk? Yuck!"),
  ## WINDYPLAINS- ##
...
#backstory intro
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (backstory a)
  ("npc17_backstory_a", "My victory, of course. I haven't been able to properly celebrate it since my jealous competitors drove me away. How could I help it I just was the best archer at the yearly competition?"),
  ## WINDYPLAINS- ##
...
### use these if there is a short period of time between the last meeting 
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (backstory later)
  ("npc17_backstory_later", "I won fair and square -- honestly! -- the yearly archery games of Tulbuk, but my jealous competitors accused me of cheating. I didn't await judgement from the elders and have been on the run since."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (backstory response 1)
  ("npc17_backstory_response_1", "How could they! You know, there is always a place at my side for a good archer."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (backstory response 2)
  ("npc17_backstory_response_2", "You should have awaited fair judgement. I won't drink with a coward."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (signup)
  ("npc17_signup", "That sounds too good to be true. I'm glad I offered you a drink, pretty {boy/face}."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (signup_2)
  ("npc17_signup_2", "At your side I'll be able to prove to these lands my skills with the bow, and when they'll hear about my travels back home, they can shall beg for my return."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (signup_response_1)
  ("npc17_signup_response_1", "Of course, and maybe earn a little while we're at it."),
  ## WINDYPLAINS- ##
...
#11
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (signup_response_2)
  ("npc17_signup_response_2", "I need a soldier to fight a war, not a travelling archer actor!"),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (payment)
  ("npc17_payment", "Talking about money... Could you spare me {reg3} denars to cover... erm... to pay for a few errands I currently have in town?"),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (payment_response)
  ("npc17_payment_response", "All right, here's {reg3} denars. I'm glad to have you at my side."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (morality_speech)
  ("npc17_morality_speech", "Excuse me, pretty {boy/face}, why are we leaving?  There's a {s21} and if we leave now we can't show these people what we're capable of."), # Nissa hates skipping tournaments.
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (2ary_morality_speech)
  ("npc17_2ary_morality_speech", "Aha, pretty {boy/face}!  {s21}  These sheppards in armor didn't know what hit them."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (personalityclash_speech)
  ("npc17_personalityclash_speech", "Ha pretty {boy/face}, I've seen you looking at {s11}. But don't trust that beautiful face of hers too much, for a serpent's tongue is hidden deep inside it."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (personalityclash_speech_b)
  ("npc17_personalityclash_speech_b", "I've told her about my fair victory at the yearly archery games, and now she spreads filthy lies around the camp! She says that I rigged those games, and that I cheat my way through life. Please don't trust her -- you know me, right?"),
  ## WINDYPLAINS- ##
...
### set off by behavior after victorious battle
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (personalityclash2_speech)
  ("npc17_personalityclash2_speech", "Hello there, pretty {boy/face}. I'm afraid I really can't fight alongside {s11} anymore."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (personalitymatch_speech)
  ("npc17_personalitymatch_speech", "Pretty {boy/face}, today I had a most pleasant talk with {s11}. I believe he and I share the same feelings about all this bloodshed that happens all around us."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (personalitymatch_speech_b)
  ("npc17_personalitymatch_speech_b", "It is a waste of good men, who could better be beaten in games and tournaments. That way they can tell about our glory and victory to their children and children's children."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (retirement_speech)
  ("npc17_retirement_speech", "It's been a wonderful time travelling with you, pretty {boy/face}, but I've seen too much fighting and too little display of my skill for any judges. It is time for me to compete in another tournament -- I've heard about a few with lots of honor and even more prize money."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (rehire_speech)
  ("npc17_rehire_speech", "Hey there, pretty {boy/face}, remember me? I went to a few tournaments and got once again accused of foul play! It's like the world doesn't like me at all. Would you mind if once again I stayed with you for a little while?"),
  ## WINDYPLAINS- ##
...
#local color strings
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (home_intro)
  ("npc17_home_intro", "Across these plains is Tulbuk, home of the most famous yearly archery games."),
  ## WINDYPLAINS- ##
...
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (home_description)
  ("npc17_home_description", "Every year the elders set out a hunting track, with targets all over the place. No-one knows in advance where they'll be putting them -- unless you sleep with them, of course. The morning of the competition every contestant will be given specially marked arrows, that were made the previous night. Luckily I knew where it was done, so I could spot the markings given to me."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (home_description_2)
  ("npc17_home_description_2", "The morning of the competition all arrows are handed over, and counted in the evening when they are collected by the elders. I really don't know how it's possible that they found more of my arrows in the evening than had been handed to me during the morning. I hit every target, so I won, fair and square."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (home_recap)
  ("npc17_home_recap", "I cheated -- I mean, got accused of cheating at the yearly archery competition of {s21}."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (honorific)
  ("npc17_honorific", "pretty {boy/face}"), # Nissa
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (kingsupport_1)
  ("npc17_kingsupport_1", "I bet you would, especially with me at your side. You would grant me a general pardon for all things I might or might not have done, wouldn't you?"),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (kingsupport_2)
  ("npc17_kingsupport_2", "Of course I'd support you. You'd be able to hold tournaments all year round, with me as winner of course. People will love it if many games will be held."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (kingsupport_2a)
  ("npc17_kingsupport_2a", "Perhaps you're right -- bread and games keep everyone happy."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (kingsupport_2b)
  ("npc17_kingsupport_2b", "You'd win all tournaments? That would be unfair!"),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - COMPILER_FIX (duplicate string)
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (kingsupport_3)
  ("npc17_kingsupport_3", "Absolutely! If you could spare me for a few weeks -- I know, it will be hard for you -- I could announce at every village that you'll hold daily tournaments and organise festivities as no-one has seen before."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (kingsupport_objection)
  ("npc17_kingsupport_objection", "Did you just send Ghazwan away to spread the word that you'd help the street urchins to find a place to live and improve their standing in the world? What if they'll think of using the foul play they learned on the street in tournaments, like me? I won't stand a chance anymore! Games would be ruined. It's a bad idea, pretty {boy/face}, I say you so."),
  ## WINDYPLAINS- ##
...
#
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (intel_mission)
  ("npc17_intel_mission", "Have you heard, pretty {boy/face}? There will be a large tournament held in {s17}. That will be the perfect opportunity to sneak around, ask questions and learn all about the {s18}. If you could give me a few weeks, I can learn almost anything."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (fief_acceptance)
  ("npc17_fief_acceptance", "You're giving me my own place, making me an elder? I'm not that old, you know. But one day I will be and it will be good to have a place of my own.  Where I can safely return to after all the tournaments have been won. I thank you for giving me {s17}."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (woman_to_woman)
  ("npc17_woman_to_woman", "Pretty face, you are not paying enough attention! If it were me in your shoes, I'd be emperor for a long time now. Don't be sad: with the right attitude you'll become a lady in no time."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - NPC Dialog (turn_against)
  ("npc17_turn_against", "I'm sorry to see you at the other side of the field, pretty {boy/face}. I've had a great time at your side, but times change. Other people just offered more than you did, so how could I honestly remain in your service? One day you'll know my true value -- if my arrows don't find you first."),
  ## WINDYPLAINS- ##
...
## WINDYPLAINS+ ## - Fixed akward description.
...
("comment_intro_noble_liege", "I see that you carry a {nobleman's/noble's} banner, although I do not recognize the origin of your standard. Know that I am always looking for good {men/warriors} to fight for me, once they prove themselves to be worthy of my trust."),
## WINDYPLAINS- ##
...
###Add some variation to these
  ...
  # ("comment_you_were_defeated_allied_unfriendly",             "I heard that {s54} defeated you. Look, try not to get too many of our men killed, will you?"), 
  # ("comment_you_were_defeated_allied",                        "I heard that {s54} defeated you. But take heart -- the tables will soon be turned!"), 
  ("comment_you_were_defeated_allied_unfriendly_2",             "I heard that {s54} defeated you. Look, try not to get too many of our men killed, will you?"), 
  ("comment_you_were_defeated_allied_2",                        "I heard that {s54} defeated you. But take heart -- the tables will soon be turned!"), 
  ## WINDYPLAINS- ##
...
#Post 0907 changes begin
  ...
  ## WINDYPLAINS+ ## - COMPILER FIX (duplicate string names)
...
#multiplayer game type names
  ...
  ## WINDYPLAINS+ ## - COMPILER_FIX (duplicate string name)
  # ("score", "Score"),
  ("score_2", "Score"),
  ## WINDYPLAINS- ##
  ("command", "Command:"),
  ...
  ## WINDYPLAINS+ ## - Show lord's reputation within character note.
  ("lord_info_string", "{reg6?:{reg4?{s54} is the ruler of {s56}.^:{s54} is a vassal of {s55} of {s56}.^}}Renown: {reg5}. Controversy: {reg15}.{s21}^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s59}^{s49}"),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - COMPILER_FIX (duplicate string names)
  ...
  ("trade_explanation_dates_2", "I tend to a grove of date palms. We grow them using well-water, and export the fruit far and wide, as they keep for many months when properly dried. As sweet as honey, and they grant the eater health and vigor."),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - "Base morale:  +{reg6}" was removed as it is no longer used.  Days on the march was added to morale report.
...
("the_coast", "the coast"),
  ...
  ## WINDYPLAINS+ ## - COMPILER_FIX (duplicate string names)
  # ("whereabouts_unknown", "whereabouts unknown"),
  ("whereabouts_unknown_2", "whereabouts unknown"),
  ## WINDYPLAINS- ##
  ...
  ## WINDYPLAINS+ ## - Bugfix to correct native typos.  Extra space unnecessary.
  ...
  ## WINDYPLAINS+ ## - Adds strings used in Custom Commander for recoloring kingdom.
  ("key_0", "0"),
  ("key_1", "1"),
  ("key_2", "2"),
  ("key_3", "3"),
