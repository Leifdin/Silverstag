...
##Narf's transitional armor begin  
  ...
  ("heraldic_armor_plate", 0, "plate_heraldic_banner_sample", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (cur_tableau_add_mesh, "mesh_plate_heraldic_tableau_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
...
## WINDYPLAINS+ ## - Heraldic Horses Mod
  # WSE horses BEGIN
...
("heraldic_tabard", 0, "sample_heraldic_tabard_banner", 1024, 1024, 0, 0, 0, 0,
	[
		(store_script_param, ":banner_mesh", 1),
		...
		(init_position, pos1),
		(position_set_z, pos1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_tabard_banner", pos1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
		]),

("heraldic_padded_cloth", 0, "sample_heraldic_padded_cloth_banner", 1024, 1024, 0, 0, 0, 0,
	[
		(store_script_param, ":banner_mesh", 1),
		...
		(position_set_y, pos1, 130),
		(cur_tableau_add_mesh, ":banner_mesh", pos1, 95, 0),
		(init_position, pos1),
		(position_set_z, pos1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_padded_cloth_banner", pos1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
		]),

("heraldic_cuir_bouilli", 0, "sample_heraldic_cuir_bouilli_banner", 1024, 1024, 0, 0, 0, 0,
	[
		(store_script_param, ":banner_mesh", 1),
		...
		(init_position, pos1),
		(position_set_x, pos1, -71),
		(position_set_y, pos1, 111),
		(cur_tableau_add_mesh, ":banner_mesh", pos1, 72, 0),
		(init_position, pos1),
		(position_set_z, pos1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_cuir_bouilli_banner", pos1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
		]),

("heraldic_mail_and_plate", 0, "sample_heraldic_mail_and_plate_banner", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 30),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_mail_and_plate_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),

("heraldic_light_mail_and_plate", 0, "sample_heraldic_light_mail_and_plate_banner", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 30),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_light_mail_and_plate_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
	   
# Heraldic fur Coat (this name was taken)
...
# try:
    ...
    # var_set = { "tableau_materials" : tableau_materials }
