 ...
 ("pbod_redefine_keys", 0, mesh_load_window, [
   (ti_on_presentation_load, 
    [(presentation_set_duration, 999999),
     ...
     (create_text_overlay, "$g_presentation_credits_obj_4", "@Press Esc to^^Disable a key", tf_left_align),
     (overlay_set_position, "$g_presentation_credits_obj_4", pos1), 
    ...
    [(store_trigger_param_1, ":object"),
	 ...
	 (else_try),    
	   ...
	   (try_begin),		                                                   # Quit from KeyConfig Presentation
		 ...
		 (presentation_set_duration, 0),
	   (try_end),    
	   ## WINDYPLAINS+ ## - Redirect key config exit button back to Silverstag's Mod Options
