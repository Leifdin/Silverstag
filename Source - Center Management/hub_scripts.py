...
("hub_initialize",
	[
		...
		(troop_set_slot, "trp_n_swadian_recruit", slot_troop_recruit_type, STRT_PEASANT),
		...
		(troop_set_slot, "trp_n_swadian_militia", slot_troop_recruit_type, STRT_PEASANT),
		...
		(troop_set_slot, "trp_n_swadian_sergeant", slot_troop_purchase_cost, 1750),
		(troop_set_slot, "trp_n_swadian_sergeant", slot_troop_recruit_type, STRT_MERCENARY),
		...
		(troop_set_slot, "trp_n_vaegir_recruit", slot_troop_recruit_type, STRT_PEASANT),
		...
		(troop_set_slot, "trp_n_vaegir_headhunter", slot_troop_recruit_type, STRT_MERCENARY),
		(troop_set_slot, "trp_n_vaegir_headhunter", slot_troop_purchase_cost, 1250),
		...
		(call_script, "script_ce_assign_troop_requirement", "trp_n_vaegir_guard", PREREQ_ELITE_MERCENARY, PREREQ_UNASSIGNED),
		(call_script, "script_ce_assign_troop_ability", "trp_n_vaegir_guard", BONUS_CHARGING_STRIKE, BONUS_UNASSIGNED),
		(troop_set_slot, "trp_n_vaegir_guard", slot_troop_purchase_cost, 2250),
		(troop_set_slot, "trp_n_vaegir_guard", slot_troop_recruit_type, STRT_MERCENARY),
		...
		(troop_set_slot, "trp_n_vaegir_bogatyr", slot_troop_purchase_cost, 4000),
		(troop_set_slot, "trp_n_vaegir_bogatyr", slot_troop_recruit_type, STRT_NOBLEMAN),
		...
		(troop_set_slot, "trp_n_khergit_recruit", slot_troop_recruit_type, STRT_PEASANT),
		
		## H2 Khergit Scout
		(troop_set_class, "trp_n_khergit_scout", CLASS_CAVALRY),
		(troop_set_slot, "trp_n_khergit_scout", slot_troop_purchase_cost, 35),
		(troop_set_slot, "trp_n_khergit_scout", slot_troop_recruit_type, STRT_PEASANT),
		...
		(troop_set_slot, "trp_n_khergit_skirmisher", slot_troop_purchase_cost, 1000),
		(troop_set_slot, "trp_n_khergit_skirmisher", slot_troop_recruit_type, STRT_MERCENARY),
		...
		(troop_set_slot, "trp_n_khergit_keshig", slot_troop_purchase_cost, 1750),
		(troop_set_slot, "trp_n_khergit_keshig", slot_troop_recruit_type, STRT_NOBLEMAN),
		...
		(troop_set_slot, "trp_n_nordic_recruit", slot_troop_recruit_type, STRT_PEASANT),
		...
		(troop_set_slot, "trp_n_rhodok_recruit", slot_troop_recruit_type, STRT_PEASANT),
		...
		(call_script, "script_ce_assign_troop_requirement", "trp_n_rhodok_siege_breaker", PREREQ_ELITE_MERCENARY, PREREQ_UNASSIGNED),
		(call_script, "script_ce_assign_troop_ability", "trp_n_rhodok_siege_breaker", BONUS_FIRING_CAPTAIN, BONUS_UNASSIGNED),
		(troop_set_slot, "trp_n_rhodok_siege_breaker", slot_troop_purchase_cost, 3000),
		(troop_set_slot, "trp_n_rhodok_siege_breaker", slot_troop_recruit_type, STRT_MERCENARY),
		...
		(troop_set_slot, "trp_n_sarranid_recruit", slot_troop_recruit_type, STRT_PEASANT),
		
		## I2 Sarranid Fighter
		(troop_set_class, "trp_n_sarranid_fighter", CLASS_INFANTRY),
		(troop_set_slot, "trp_n_sarranid_fighter", slot_troop_purchase_cost, 35),
		(troop_set_slot, "trp_n_sarranid_fighter", slot_troop_recruit_type, STRT_PEASANT),
		...
		(troop_set_slot, "trp_n_sarranid_skirmisher", slot_troop_purchase_cost, 4750),
		(troop_set_slot, "trp_n_sarranid_skirmisher", slot_troop_recruit_type, STRT_MERCENARY),
		...
		(try_begin),
			...
			(try_begin),
				...
				(try_begin),
					...
					(try_begin), ## UNIQUE - PRAVEN
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_swadian_lancer", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_swadian_lancer", ":lord_no", ":cavalry"),
					(else_try), ## AFFILIATED - SWADIA
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_swadian_knight", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_swadian_knight", ":lord_no", ":cavalry"),
					(try_end),
				...
				(try_begin),
					(ge, ":infantry", 1),
					(try_begin),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_swadian_sergeant", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_swadian_sergeant", ":lord_no", ":infantry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_swadian_militia", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_swadian_militia", ":lord_no", ":infantry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_swadian_recruit", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_swadian_recruit", ":lord_no", ":infantry"),
					(try_end),
				...
				(try_begin),
					...
					(try_begin), ## UNIQUE - SUNO
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_swadian_crossbowman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_swadian_crossbowman", ":lord_no", ":archers"),
					(try_end),
			...
			(else_try),
				...
				(try_begin),
					...
					(try_begin), ## AFFILIATED - VAEGIRS
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_vaegir_headhunter", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_vaegir_headhunter", ":lord_no", ":cavalry"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_CAVALRY, ":cavalry"),
				(try_end),
				# infantry
				(try_begin),
					(ge, ":infantry", 1),
					(try_begin), ## AFFILIATED - VAEGIRS
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_vaegir_guard", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_vaegir_guard", ":lord_no", ":infantry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_vaegir_skirmisher", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_vaegir_skirmisher", ":lord_no", ":infantry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_vaegir_recruit", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_vaegir_recruit", ":lord_no", ":infantry"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_INFANTRY, ":infantry"),
				(try_end),
				# archers
				(try_begin),
					(ge, ":archers", 1),
					(try_begin), ## AFFILIATED - VAEGIRS
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_vaegir_bowman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_vaegir_bowman", ":lord_no", ":archers"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_ARCHERS, ":archers"),
				(try_end),
				# horse archers
				(try_begin),
					(ge, ":horse_archers", 1),
					(try_begin),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_vaegir_bogatyr", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_vaegir_bogatyr", ":lord_no", ":horse_archers"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_vaegir_raider", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_vaegir_raider", ":lord_no", ":horse_archers"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_HORSE_ARCHERS, ":horse_archers"),
				(try_end),
			...
			(else_try),
				...
				(try_begin),
					(ge, ":cavalry", 1),
					(try_begin),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_khergit_keshig", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_khergit_keshig", ":lord_no", ":cavalry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_khergit_lancer", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_khergit_lancer", ":lord_no", ":cavalry"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_CAVALRY, ":cavalry"),
				(try_end),
				# infantry
				(try_begin),
					(ge, ":infantry", 1),
					(try_begin),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_khergit_clansman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_khergit_clansman", ":lord_no", ":infantry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_khergit_shaman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_khergit_shaman", ":lord_no", ":infantry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_khergit_recruit", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_khergit_recruit", ":lord_no", ":infantry"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_INFANTRY, ":infantry"),
				(try_end),
				# archers
				(try_begin),
					(ge, ":archers", 1),
					(try_begin),
						#~ (call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_khergit_scout", ":lord_no"),
						#~ (call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_khergit_scout", ":lord_no", ":archers"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_ARCHERS, ":archers"),
				(try_end),
				# horse archers
				(try_begin),
					(ge, ":horse_archers", 1),
					(try_begin),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_khergit_skirmisher", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_khergit_skirmisher", ":lord_no", ":horse_archers"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_khergit_scout", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_khergit_scout", ":lord_no", ":horse_archers"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_HORSE_ARCHERS, ":horse_archers"),
				(try_end),
			...
			(else_try),
				...
				(try_begin),
					(ge, ":cavalry", 1),
					(try_begin), ## UNIQUE - C6
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_nordic_retainer", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_nordic_retainer", ":lord_no", ":cavalry"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_CAVALRY, ":cavalry"),
				(try_end),
				# infantry
				(try_begin),
					...
					(try_begin), ## AFFILIATED - T7
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_nordic_spearman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_nordic_spearman", ":lord_no", ":infantry"),
					(else_try), ## AFFILIATED - T6
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_nordic_berserker", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_nordic_berserker", ":lord_no", ":infantry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_nordic_skald", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_nordic_skald", ":lord_no", ":infantry"),
					(else_try), ## AFFILIATED - T5
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_nordic_recruit", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_nordic_recruit", ":lord_no", ":infantry"),
					(else_try),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_INFANTRY, ":infantry"),
				(try_end),
				...
				(try_begin),
					...
					(try_begin), ## AFFILIATED - T4
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_nordic_retinue_archer", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_nordic_retinue_archer", ":lord_no", ":archers"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_nordic_tracker", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_nordic_tracker", ":lord_no", ":archers"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_ARCHERS, ":archers"),
				(try_end),
				# horse archers
			...
			(else_try),
				...
				(try_begin),
					...
					(try_begin), ## AFFILIATED
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_rhodok_pikeman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_rhodok_pikeman", ":lord_no", ":infantry"),
					(else_try), ## AFFILIATED
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_rhodok_foot_knight", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_rhodok_foot_knight", ":lord_no", ":infantry"),
					(else_try), ## AFFILIATED
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_rhodok_halberdier", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_rhodok_halberdier", ":lord_no", ":infantry"),
					(else_try),
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_rhodok_footman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_rhodok_footman", ":lord_no", ":infantry"),
					(else_try), ## UNIQUE
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_rhodok_recruit", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_rhodok_recruit", ":lord_no", ":infantry"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_INFANTRY, ":infantry"),
				(try_end),
				# archers
				(try_begin),
					(ge, ":archers", 1),
					(try_begin), ## AFFILIATED
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_rhodok_siege_breaker", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_rhodok_siege_breaker", ":lord_no", ":archers"),
					(else_try), ## UNIQUE
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_rhodok_ranger", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_rhodok_ranger", ":lord_no", ":archers"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_ARCHERS, ":archers"),
				(try_end),
				# horse archers
			...
			(else_try),
				...
				(try_begin),
					(ge, ":cavalry", 1),
					(try_begin), ## AFFILIATED
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_sarranid_mamluke", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_sarranid_mamluke", ":lord_no", ":cavalry"),
					(else_try),  ## AFFILIATED
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_CAVALRY, ":cavalry"),
				(try_end),
				...
				(try_begin),
					(ge, ":infantry", 1),
					(try_begin), ## UNIQUE
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_sarranid_guard", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_sarranid_guard", ":lord_no", ":infantry"),
					(else_try),  ## AFFILIATED
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_sarranid_fighter", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_sarranid_fighter", ":lord_no", ":infantry"),
					(else_try),  ## UNIQUE
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_sarranid_recruit", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_sarranid_recruit", ":lord_no", ":infantry"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_INFANTRY, ":infantry"),
				(try_end),
				# archers
				(try_begin),
					(ge, ":archers", 1),
					(try_begin), ## AFFILIATED
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_sarranid_marksman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_sarranid_marksman", ":lord_no", ":archers"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_ARCHERS, ":archers"),
				(try_end),
				# horse archers
				(try_begin),
					(ge, ":horse_archers", 1),
					(try_begin), ## AFFILIATED
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_sarranid_skirmisher", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_sarranid_skirmisher", ":lord_no", ":horse_archers"),
					(else_try),  ## UNIQUE
						(call_script, "script_cf_hub_troop_can_be_recruited_here", ":center_no", "trp_n_sarranid_tribesman", ":lord_no"),
						(call_script, "script_cf_hub_ai_lord_wants_to_purchase_troop", ":center_no", "trp_n_sarranid_tribesman", ":lord_no", ":horse_archers"),
					(try_end),
					(call_script, "script_hub_ai_lord_considers_mercenaries", ":lord_no", ":center_no", AI_RECRUIT_HORSE_ARCHERS, ":horse_archers"),
				(try_end),
